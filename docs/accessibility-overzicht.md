...
| Zoekfunctie en/of **HTML**-sitemappagina toevoegen — `sitemap.xml` telt niet: dat is machineleesbaar, de `<loc>`-waarden zijn tekst en geen links | Sitebreed — navigatie                                                                                                            | 2.4.5                                                                                                                           |
...
| Bevinding                                             | Status |
| ----------------------------------------------------- | ------ | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Links volgen is de enige manier om pagina's te vinden | ✍️     | Footer verwijst sinds 14-08 naar `sitemap.xml`; dat is een crawler-bestand en geen sitemap voor bezoekers (WCAG-techniek G63 vraagt een HTML-pagina met echte links). Nog geen zoekveld. De 31 URLs uit die XML zijn wel precies de inventaris voor zo'n pagina |
