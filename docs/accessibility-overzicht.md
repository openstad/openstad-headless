...
| 5   | Kop **H1 "Sitemap"** boven de lijst zetten (stijl-dropdown in de RTE) — de pagina begint nu bij `h2` en heeft helemaal geen `h1` | `/sitemap`                                                                                                                      | 1.3.1 / 2.4.6                                                                                                 |
...
| Bevinding                                             | Status | Toelichting                                                                                                                                                                                                                                                |
| ----------------------------------------------------- | ------ | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Links volgen is de enige manier om pagina's te vinden | ✅     | `/sitemap` staat sinds 14-08 live: 31 links onder vier `h2`'s, subpagina's genest. Geverifieerd tegen `sitemap.xml` — compleet. De footer wijst er nu naartoe in plaats van naar het XML-bestand. Navigatie + sitemap zijn samen de twee vereiste manieren |
