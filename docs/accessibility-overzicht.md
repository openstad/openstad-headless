...
| ----- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------- |
| 1     | ~~`logoAltText`~~ — **gedaan 14-08**: header staat op "OpenStad.org, naar de homepage". Rest: het **footer**logo is géén link, dus daar hoort alleen `OpenStad.org` (nu staat er ook "naar de homepage")                                              | Sitebreed — Algemene instellingen, `footerLogoAltText`                                                                          | 2.4.4                                          |
...
| 7     | **Beschrijving** van de schaalvraag herschrijven: er staat "1 = zeer ontevreden, 5 = zeer tevreden", maar de schermlezer hoort "1 = Heel slecht … 5 = Heel goed". Die tweede reeks zit hard in de code, dus de Beschrijving moet zich daarnaar voegen | `/enquete` — Enquête-widget, tab **Items**, vraag "Hoe tevreden ben je met jouw buurt?", veld **Beschrijving**                  | 3.3.2                                          |
