...
> ⚠️ **Let op — deze leken content, maar zijn het niet.** Bij de eerste analyse stonden de
> "3× `h1`" en de "nepkop Lorem ipsum" op de redacteurslijst. Live onderzoek wees uit dat ze uit
> de widgets zelf komen. Wie in het CMS gaat zoeken vindt daar niets om aan te passen.
>
