...
| Accountgegevens: e-mailadres niet volledig leesbaar    | ✅      | De bevinding zelf is opgelost: het e-mailveld was een `readOnly` input en is nu leestekst met `overflow-wrap: anywhere`. 14-08 live bevestigd, past volledig op 250px                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
| Accountgegevens: de overige velden kappen óók af       | ⚠️      | **Bewuste afwijking, 14-08.** Naam, straat, huisnummer, postcode, woonplaats en gebruikersnaam zijn nog `readOnly` inputs (`packages/account/src/account.tsx:408`). Gemeten op 250px met realistische waarden: "Anne-Marie van der Heijden-Boersma" toont 102 van 319px, "Burgemeester Van Roijensingel" 102 van 265px, een lang e-mailadres 165 van 415px. De pagina scrollt niet horizontaal, dus die tekst is niet te bereiken. Alleen de postcode past. Dezelfde oplossing als bij e-mail zou dit dichten, maar dat verandert het uiterlijk van de kijkmodus voor elk project dat de account-widget gebruikt; die afweging is bewust op uiterlijk beslist |
...
| Keuzewijzer en accountgegevens                               | ⚠️ / ❓ | Volgen 1.4.4. Accountgegevens 14-08 gemeten op 250px: geen horizontaal scrollen, maar de `readOnly`-velden kappen lange waarden af — bewuste afwijking, zie 1.4.4 |
