...
const createTestConfig = (
  overrides: Partial<EnqueteWidgetProps> = {}
): EnqueteWidgetProps => ({
  api: {
      ...
      options: [
        {
          trigger: '0',
          titles: [
            { key: 'Option A', defaultValue: false, isOtherOption: false },
          ],
        },
        {
          trigger: '1',
          titles: [
            { key: 'Option B', defaultValue: false, isOtherOption: false },
          ],
        },
      ],
      matrix: { rows: [], columns: [] },
    ...
    it('handles missing updatedAt field gracefully', () => {
      ...
      cy.window().then((win) => {
        ...
        win.localStorage.setItem(
          key,
          JSON.stringify({ data: { textField: 'test' } })
        );
      });
