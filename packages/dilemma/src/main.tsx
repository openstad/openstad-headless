...
import { DilemmaField, DilemmaProps } from './dilemma.js';
...
const config: DilemmaProps = {
  ...
  login: {
    ...
    anonymous: {
      url: `${import.meta.env.VITE_API_URL}/auth/project/${
        import.meta.env.VITE_PROJECT_ID
      }/login?forceNewLogin=1&useAuth=anonymous&redirectUri=${
        document.location
      }`,
    },
  },
  ...
  infoField:
    'Lorem amet voluptate consequat sunt nulla culpa quis. Voluptate consequat, sunt nulla culpa quis proident. Nulla culpa quis proident ea do id. Quis proident ea do id minim. Ea do, id minim laboris.',
  options: [
    {
      id: 0,
