...
export declare function Filters({ dataStore, resources, sorting, tagGroups, tagsLimitation, onUpdateFilter, className, showActiveTags, preFilterTags, autoApply, ...props }: Props): React.JSX.Element | null;
export {};
