...
module.exports = (app) => {
  ...
  app.get('/api/admin/unique-code/:uniqueCodeid',          clientMw.withOne,     codeMw.withOne,   adminApiUniqueCodeController.show);
  app.post('/api/admin/unique-code',                       clientMw.withOne,     codeMw.create,    adminApiUniqueCodeController.show);
  app.post('/api/admin/unique-code/:uniqueCodeid/delete',  codeMw.withOne,       codeMw.deleteOne, adminApiUniqueCodeController.delete);
