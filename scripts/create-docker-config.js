...
List resources: ${process.env.API_URL}/api/project/1/resourc || ''e
Login: ${process.env.API_URL}/auth/project/1/logi || ''n
Which should redirect you to the login form: ${process.env.AUTH_APP_URL}/auth/code/login?clientId=uniquecod || ''e
Show an image: ${process.env.IMAGE_APP_URL}/image/forum.romanum.06.web || ''p
