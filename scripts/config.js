...
async function setupEnvVars() {
  ...
  let BASE_PORT = (process.env.BASE_PORT =
    parseInt(process.env.BASE_PORT) || 31400);
  ...
  process.env.DB_PASSWORD =
    process.env.DB_PASSWORD || generateRandomToken({ length: 32 });
  ...
  let API_DOMAIN = (process.env.API_DOMAIN =
  ...
  let API_URL =
    ...
    process.env.API_URL =
      process.env.API_URL ||
      (process.env.FORCE_HTTP ? 'http://' : 'https://') + API_DOMAIN);
  let API_FIXED_AUTH_KEY =
    process.env.API_FIXED_AUTH_KEY ||
    process.env.AUTH_FIRST_LOGIN_CODE ||
    generateRandomToken({ length: 2048 });
  let API_AUTH_FIXEDAUTHTOKENS = (process.env.API_AUTH_FIXEDAUTHTOKENS =
    process.env.API_AUTH_FIXEDAUTHTOKENS ||
    `[{"token":"${API_FIXED_AUTH_KEY}","userId":"1","authProvider":"openstad"}]`);

  let AUTH_PORT = (process.env.AUTH_PORT =
    process.env.AUTH_PORT || BASE_PORT + 30);
  let AUTH_DOMAIN = (process.env.AUTH_DOMAIN =
  ...
  let AUTH_ADMIN_CLIENT_ID = (process.env.AUTH_ADMIN_CLIENT_ID =
    process.env.AUTH_ADMIN_CLIENT_ID || generateRandomToken({ length: 64 }));
  let AUTH_ADMIN_CLIENT_SECRET = (process.env.AUTH_ADMIN_CLIENT_SECRET =
    process.env.AUTH_ADMIN_CLIENT_SECRET ||
    generateRandomToken({ length: 64 }));
  let AUTH_FIRST_CLIENT_ID = (process.env.AUTH_FIRST_CLIENT_ID =
    process.env.AUTH_FIRST_CLIENT_ID || generateRandomToken({ length: 64 }));
  let AUTH_FIRST_CLIENT_SECRET = (process.env.AUTH_FIRST_CLIENT_SECRET =
    process.env.AUTH_FIRST_CLIENT_SECRET ||
    generateRandomToken({ length: 64 }));
  let AUTH_PHONE_HASH_SALT = (process.env.AUTH_PHONE_HASH_SALT =
    process.env.AUTH_PHONE_HASH_SALT || generateRandomToken({ length: 32 }));

  let IMAGE_PORT_API = (process.env.IMAGE_PORT_API =
    process.env.IMAGE_PORT_API || BASE_PORT + 50);
  let IMAGE_DOMAIN = (process.env.IMAGE_DOMAIN =
    process.env.IMAGE_DOMAIN ||
    (process.env.BASE_DOMAIN == 'localhost'
      ? 'localhost:' + IMAGE_PORT_API
      : 'image.' + process.env.BASE_DOMAIN));
  let IMAGE_APP_URL = (process.env.IMAGE_APP_URL =
  ...
  let IMAGE_PORT_IMAGE_SERVER = (process.env.IMAGE_PORT_IMAGE_SERVER =
    process.env.IMAGE_PORT_IMAGE_SERVER || IMAGE_PORT_API + 1);
  let IMAGE_VERIFICATION_TOKEN = (process.env.IMAGE_VERIFICATION_TOKEN =
    process.env.IMAGE_VERIFICATION_TOKEN ||
    generateRandomToken({ length: 32 }));

  let ADMIN_PORT = (process.env.ADMIN_PORT =
    process.env.ADMIN_PORT || BASE_PORT + 70);
  let ADMIN_DOMAIN = (process.env.ADMIN_DOMAIN =
    process.env.ADMIN_DOMAIN ||
    (process.env.BASE_DOMAIN == 'localhost'
      ? 'localhost:' + ADMIN_PORT
      : 'admin.' + process.env.BASE_DOMAIN));
  let ADMIN_URL = (process.env.ADMIN_URL =
    process.env.ADMIN_URL ||
    (process.env.FORCE_HTTP ? 'http://' : 'https://') + ADMIN_DOMAIN);
  let ADMIN_COOKIE_SECRET = (process.env.ADMIN_COOKIE_SECRET =
    process.env.ADMIN_COOKIE_SECRET || generateRandomToken({ length: 64 }));

  let CMS_PORT = (process.env.CMS_PORT =
    process.env.CMS_PORT || BASE_PORT + 90);
  let CMS_DOMAIN = (process.env.CMS_DOMAIN =
    process.env.CMS_DOMAIN ||
    (process.env.BASE_DOMAIN == 'localhost'
      ? 'localhost:' + CMS_PORT
      : 'cms.' + process.env.BASE_DOMAIN));
  let CMS_URL = (process.env.CMS_URL =
    process.env.CMS_URL ||
  ...
  let CMS_DEFAULT_SETTINGS = (process.env.CMS_DEFAULT_SETTINGS =
    process.env.CMS_DEFAULT_SETTINGS || '{}');
  ...
  process.env.API_DB_HOST =
    process.env.API_DB_HOST || process.env.DB_HOST || '';
  process.env.API_DB_USERNAME =
    process.env.API_DB_USERNAME || process.env.DB_USERNAME;
  process.env.API_DB_PASSWORD =
    process.env.API_DB_PASSWORD || process.env.DB_PASSWORD;
  ...
  process.env.API_FROM_EMAIL_ADDRESS =
    process.env.API_FROM_EMAIL_ADDRESS || process.env.FROM_EMAIL_ADDRESS || '';
  process.env.API_SMTP_SECURE =
    process.env.API_SMTP_SECURE || process.env.SMTP_SECURE || false;
  process.env.API_SMTP_PORT =
    process.env.API_SMTP_PORT || process.env.SMTP_PORT || '';
  process.env.API_SMTP_HOST =
    process.env.API_SMTP_HOST || process.env.SMTP_HOST || '';
  process.env.API_SMTP_USERNAME =
    process.env.API_SMTP_USERNAME || process.env.SMTP_USERNAME || '';
  process.env.API_SMTP_PASSWORD =
    process.env.API_SMTP_PASSWORD || process.env.SMTP_PASSWORD || '';

  process.env.FROM_EMAIL_ADDRESS =
    process.env.FROM_EMAIL_ADDRESS || process.env.API_FROM_EMAIL_ADDRESS;
  process.env.SMTP_SECURE =
    process.env.SMTP_SECURE || process.env.API_SMTP_SECURE || false;
  ...
  process.env.SMTP_USERNAME =
    process.env.SMTP_USERNAME || process.env.API_SMTP_USERNAME;
  process.env.SMTP_PASSWORD =
    process.env.SMTP_PASSWORD || process.env.API_SMTP_PASSWORD;
  ...
  process.env.AUTH_DB_HOST =
    process.env.AUTH_DB_HOST || process.env.DB_HOST || '';
  process.env.AUTH_DB_USERNAME =
    process.env.AUTH_DB_USERNAME || process.env.DB_USERNAME || '';
  ...
  process.env.AUTH_DB_REQUIRE_SSL =
  ...
  process.env.AUTH_MAIL_SERVER_PORT =
    process.env.AUTH_MAIL_SERVER_PORT || process.env.SMTP_PORT;
  process.env.AUTH_MAIL_SERVER_SECURE = true;
  process.env.AUTH_MAIL_SERVER_PASSWORD =
    process.env.AUTH_MAIL_SERVER_PASSWORD || process.env.SMTP_PASSWORD;
  process.env.AUTH_MAIL_SERVER_USER_NAME =
    process.env.AUTH_MAIL_SERVER_USER_NAME || process.env.SMTP_USERNAME;
  process.env.AUTH_FROM_NAME = process.env.AUTH_FROM_NAME || '';
  process.env.AUTH_FROM_EMAIL =
    process.env.AUTH_FROM_EMAIL || process.env.FROM_EMAIL_ADDRESS;
  ...
  process.env.AUTH_FIRST_LOGIN_CODE =
    process.env.AUTH_FIRST_LOGIN_CODE || generateRandomToken({ length: 32 });
  ...
  process.env.IMAGE_VERIFICATION_TOKEN =
    IMAGE_VERIFICATION_TOKEN || generateRandomToken({ length: 32 });
  ...
  process.env.IMAGE_THROTTLE_CC_PROCESSORS =
    process.env.IMAGE_THROTTLE_CC_PROCESSORS || 4;
  process.env.IMAGE_THROTTLE_CC_PREFETCHER =
    process.env.IMAGE_THROTTLE_CC_PREFETCHER || 20;
  process.env.IMAGE_THROTTLE_CC_REQUESTS =
    process.env.IMAGE_THROTTLE_CC_REQUESTS || 100;

  process.env.IMAGE_HQ_ORIGINAL_MAX_PIXELS =
