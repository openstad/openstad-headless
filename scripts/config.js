...
async function setupEnvVars() {
  ...
  process.env.API_DB_PORT = process.env.API_DB_PORT || process.env.DB_PORT || '';
  ...
  process.env.AUTH_DB_PORT = process.env.AUTH_DB_PORT || process.env.DB_PORT || '';
  ...
  process.env.AUTH_DB_DIALECT = process.env.AUTH_DB_DIALECT || process.env.DB_DIALECT || 'mariadb';
...
API_DATABASE_PORT=${process.env.API_DB_PORT}
