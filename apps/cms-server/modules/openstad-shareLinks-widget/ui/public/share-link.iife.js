var ApostropheWidgetsShareLinks = (function (E1, i, P3) {
  'use strict';
  var k1,
    f1 = P3;
  if (process.env.NODE_ENV === 'production')
    ((k1 = f1.createRoot), f1.hydrateRoot);
  else {
    var Y1 = f1.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED;
    k1 = function (e, n) {
      Y1.usingClientEntryPoint = !0;
      try {
        return f1.createRoot(e, n);
      } finally {
        Y1.usingClientEntryPoint = !1;
      }
    };
  }
  const q8 = '',
  ...
  function w3(e, n) {
    if (a1(e) != 'object' || !e) return e;
    var r = e[Symbol.toPrimitive];
    if (r !== void 0) {
      var t = r.call(e, n || 'default');
      if (a1(t) != 'object') return t;
  ...
  function L3() {
    ...
    function u(d, O, m) {
      ...
      for (y in O) t.call(O, y) && !s.hasOwnProperty(y) && (j[y] = O[y]);
      if (d && d.defaultProps)
        for (y in ((O = d.defaultProps), O)) j[y] === void 0 && (j[y] = O[y]);
      return {
        $$typeof: n,
        type: d,
        key: w,
    ...
    return ((c1.Fragment = r), (c1.jsx = u), (c1.jsxs = u), c1);
  }
  var o1 = {};
  /**
   * @license React
      ...
      z1 ||
        ...
        process.env.NODE_ENV !== 'production' &&
          (function () {
            ...
            function X(c, C, f) {
              {
                var h = V.ReactDebugCurrentFrame,
                  P = h.getStackAddendum();
                P !== '' && ((C += '%s'), (f = f.concat([P])));
                var N = f.map(function (v) {
                  return String(v);
                });
                (N.unshift('Warning: ' + C),
            ...
            function H(c) {
              ...
              if (typeof c == 'object')
                switch (c.$$typeof) {
                  case d:
                    var C = c;
                    return w1(C) + '.Consumer';
                  case u:
                    var f = c;
                    return w1(f._context) + '.Provider';
                  case O:
                    return R1(c, c.render, 'ForwardRef');
                  case j:
                    var h = c.displayName || null;
                    return h !== null ? h : H(c.type) || 'Memo';
                  case w: {
                    var P = c,
                      N = P._payload,
                      v = P._init;
            ...
            function h8() {
              {
                if ((Y--, Y === 0)) {
                  ...
                  Object.defineProperties(console, {
                    ...
                    error: T({}, c, { value: d1 }),
                    group: T({}, c, { value: p1 }),
                    groupCollapsed: T({}, c, { value: o3 }),
                    groupEnd: T({}, c, { value: i3 }),
                  });
                }
                Y < 0 &&
                  L(
            ...
            var K1 = V.ReactCurrentDispatcher,
              Z1;
            function x1(c, C, f) {
              {
                if (Z1 === void 0)
...
` +
            ...
            var I1 = !1,
              L1;
            {
              var j8 = typeof WeakMap == 'function' ? WeakMap : Map;
              L1 = new j8();
            }
            function l3(c, C) {
              if (!c || I1) return '';
              ...
              var N;
              ((N = K1.current), (K1.current = null), y8());
              try {
                if (C) {
                  var v = function () {
                    throw Error();
...
` + g[x].replace(' at new ', ' at ');
                            return (
                              c.displayName &&
                                ...
                                (_ = _.replace('<anonymous>', c.displayName)),
                              typeof c == 'function' && L1.set(c, _),
                              _
                            );
                          }
                        while (x >= 1 && D >= 0);
              ...
              var n1 = c ? c.displayName || c.name : '',
                G = n1 ? x1(n1) : '';
              return (typeof c == 'function' && L1.set(c, G), G);
            }
            function g8(c, C, f) {
              return l3(c, !1);
            }
            ...
            function D1(c, C, f) {
              if (c == null) return '';
              if (typeof c == 'function') return l3(c, v8(c));
              if (typeof c == 'string') return x1(c);
              switch (c) {
                case m:
                  return x1('Suspense');
                case y:
            ...
            var C1 = Object.prototype.hasOwnProperty,
              u3 = {},
              d3 = V.ReactDebugCurrentFrame;
            function S1(c) {
              if (c) {
                var C = c._owner,
                  f = D1(c.type, c._source, C ? C.type : null);
                d3.setExtraStackFrame(f);
              } else d3.setExtraStackFrame(null);
            }
            function P8(c, C, f, h, P) {
              {
                var N = Function.call.bind(C1);
                for (var v in c)
                  if (N(c, v)) {
                    var g = void 0;
                    try {
                    ...
                    (g &&
                      ...
                      g instanceof Error &&
                        ...
                        ((u3[g.message] = !0),
                        S1(P),
                        L('Failed %s type: %s', f, g.message),
                        S1(null)));
                  }
              }
            }
            var w8 = Array.isArray;
            function F1(c) {
              return w8(c);
            }
            function N8(c) {
            ...
            var b1 = V.ReactCurrentOwner,
              L8 = { key: !0, ref: !0, __self: !0, __source: !0 },
              b3,
              f3,
              B1;
            B1 = {};
            ...
            function E8(c, C) {
              if (
                ...
                b1.current &&
                C &&
                b1.current.stateNode !== C
              ) {
                var f = H(b1.current.type);
                B1[f] ||
                  (L(
            ...
            function H8(c, C, f, h, P) {
              {
                var N,
                  ...
                  $ = null;
                (f !== void 0 && (C3(f), (g = '' + f)),
                  S8(C) && (C3(C.key), (g = '' + C.key)),
                  D8(C) && (($ = C.ref), E8(C, P)));
                for (N in C)
                  C1.call(C, N) && !L8.hasOwnProperty(N) && (v[N] = C[N]);
                if (c && c.defaultProps) {
                ...
                return M8(c, g, $, P, h, b1.current, v);
              }
            }
            var A1 = V.ReactCurrentOwner,
              O3 = V.ReactDebugCurrentFrame;
            function t1(c) {
              if (c) {
                var C = c._owner,
                  f = D1(c.type, c._source, C ? C.type : null);
                O3.setExtraStackFrame(f);
              } else O3.setExtraStackFrame(null);
            }
            var q1;
            q1 = !1;
            function W1(c) {
            ...
            function V8(c) {
              {
                var C = m3();
                if (!C) {
                  var f = typeof c == 'string' ? c : c.displayName || c.name;
                  f &&
                    (C =
                      `
...
Check the top-level render call using <` +
            ...
            function h3(c, C) {
              {
                ...
                (c &&
                  c._owner &&
                  c._owner !== A1.current &&
                  (h = ' It was passed a child from ' + H(c._owner.type) + '.'),
                  t1(c),
                  L(
            ...
            function T8(c) {
              {
                ...
                if (typeof C == 'function') f = C.propTypes;
                  ...
                  typeof C == 'object' &&
                  (C.$$typeof === O || C.$$typeof === j)
                )
                  f = C.propTypes;
                else return;
                if (f) {
                  var h = H(C);
                  P8(f, c.props, 'prop', h, c);
                } else if (C.PropTypes !== void 0 && !q1) {
                  q1 = !0;
                  var P = H(C);
                  L(
            ...
            function R8(c) {
              {
                for (var C = Object.keys(c.props), f = 0; f < C.length; f++) {
                  var h = C[f];
                  if (h !== 'children' && h !== 'key') {
                    (t1(c),
                      L(
            ...
            function v3(c, C, f, h, P, N) {
              {
                ...
                if (v) {
                  ...
                  if (_ !== void 0)
                    if (h)
                      if (F1(_)) {
                        for (var n1 = 0; n1 < _.length; n1++) j3(_[n1], c);
                ...
                if (C1.call(C, 'key')) {
                  var G = H(c),
                    M = Object.keys(C).filter(function (A8) {
                      return A8 !== 'key';
                    }),
                    U1 =
                      M.length > 0
...
React keys must be passed directly to JSX without using spread:
  ...
  <%s key={someKey} {...props} />`,
            ...
            var I8 = Z8,
              F8 = K8;
            ((o1.Fragment = t), (o1.jsx = I8), (o1.jsxs = F8));
          })()),
      o1
    );
  }
  ...
  function Q1(e) {
    for (var n = 1; n < arguments.length; n++) {
      ...
      n % 2
        ? X1(Object(r), !0).forEach(function (t) {
            b(e, t, r[t]);
          })
        : Object.getOwnPropertyDescriptors
          ? Object.defineProperties(e, Object.getOwnPropertyDescriptors(r))
          : X1(Object(r)).forEach(function (t) {
  ...
  var H1 = i.forwardRef(function (e, n) {
    var r = e.appearance,
      t = e.busy,
      a = e.disabled,
      s = e.children,
        ...
        Q1(
          {
            ...
            className: l(
              ...
              d === 'danger' && 'utrecht-button--danger',
              d === 'warning' && 'utrecht-button--warning',
              d === 'ready' && 'utrecht-button--ready',
              O === !0 && 'utrecht-button--pressed',
              u
            ),
            'aria-busy': t || void 0,
  ...
  var k3 = ['appearance', 'className', 'level'];
  function e6(e, n) {
    var r = Object.keys(e);
    if (Object.getOwnPropertySymbols) {
      var t = Object.getOwnPropertySymbols(e);
  ...
  var O1 = i.forwardRef(function (e, n) {
    var r = e.appearance,
      t = e.className,
      a = e.level,
      s = p(e, k3),
            ...
            : a === 4
              ...
              : a === 5
                ...
                : a === 6
                  ? 'h6'
                  : 'h1',
      O = r && u.indexOf(r) !== -1 ? r : u[a - 1] || 'utrecht-heading-1';
    return o.jsx(d, r6(r6({ className: l(O, t) }, s), {}, { ref: n }));
  });
  O1.displayName = 'Heading';
  var $3 = [
      'id',
      'label',
      'className',
    ...
    M3 = ['children', 'group', 'headingLevel', 'heading'];
  function t6(e, n) {
    var r = Object.keys(e);
    if (Object.getOwnPropertySymbols) {
      var t = Object.getOwnPropertySymbols(e);
  ...
  var H3 = function () {
    ...
    _3 = i.forwardRef(function (e, n) {
      var r = e.id,
        ...
        L = p(e, $3),
        X = {
          className: l('utrecht-accordion__panel', {
            'utrecht-accordion__panel--expanded': O,
          }),
          hidden: !O,
          'aria-hidden': !O,
        },
        q = I || (I === null ? null : o.jsx(H3, {}));
      V === 'utrecht' && (q = null);
      var Q = 'utrecht-accordion',
        e1 = r || i.useId(),
        r1 = ''.concat(Q).concat(e1, '-button'),
        W = ''.concat(Q).concat(e1, '-panel');
      return o.jsxs(
        'div',
        R(
          R(
            { className: l('utrecht-accordion__section', a), id: r, ref: n },
            L
          ),
          {},
          {
            children: [
              o.jsx(O1, {
                level: u,
                className: l('utrecht-accordion__header'),
                children: o.jsxs(H1, {
                  className: l(
                    'utrecht-accordion__button',
                    b({}, 'utrecht-accordion__button--utrecht', V === 'utrecht')
                  ),
              ...
              y
                ? o.jsx(
                    'section',
                    R(
                      R({ id: W, 'aria-labelledby': r1 }, X),
                      {},
                      { children: j }
                    )
                  )
                : o.jsx('div', R(R({ id: W }, X), {}, { children: j })),
            ],
          }
        )
      );
    });
  _3.displayName = 'AccordionSection';
  var V3 = i.forwardRef(function (e, n) {
    var r = e.children,
      t = e.group,
      a = e.headingLevel,
      s = e.heading,
    ...
    return o.jsxs(o.Fragment, {
      children: [
        !!s && typeof a == 'number' && o.jsx(O1, { level: a, children: s }),
        o.jsx(
          'div',
          R(
            R(
              {
                className: l('utrecht-accordion'),
                role: t ? 'group' : void 0,
  ...
  V3.displayName = 'Accordion';
  var T3 = ['children', 'className', 'icon', 'type'];
  function n6(e, n) {
    var r = Object.keys(e);
    if (Object.getOwnPropertySymbols) {
      var t = Object.getOwnPropertySymbols(e);
  ...
  var R3 = i.forwardRef(function (e, n) {
    var r = e.children,
      t = e.className,
      a = e.icon,
      s = e.type,
  ...
  var Z3 = i.forwardRef(function (e, n) {
    var r = e.children,
      t = e.className,
      a = e.icon,
      s = e.type,
    ...
    return o.jsxs(
      ...
      o6(
        ...
        {
          ref: n,
          className: l('utrecht-alert-dialog', {
  ...
  Z3.displayName = 'AlertDialog';
  var I3 = ['children', 'className'];
  function i6(e, n) {
    var r = Object.keys(e);
    if (Object.getOwnPropertySymbols) {
      var t = Object.getOwnPropertySymbols(e);
  ...
  var F3 = i.forwardRef(function (e, n) {
    var r = e.children,
      t = e.className,
      a = p(e, I3);
    return o.jsx(
      ...
      s6(
        s6({}, a),
        {},
        { ref: n, className: l('utrecht-article', t), children: r }
      )
    );
  });
  ...
  function u6(e) {
    for (var n = 1; n < arguments.length; n++) {
      var r = arguments[n] != null ? arguments[n] : {};
      n % 2
        ? l6(Object(r), !0).forEach(function (t) {
            b(e, t, r[t]);
          })
        : Object.getOwnPropertyDescriptors
          ? Object.defineProperties(e, Object.getOwnPropertyDescriptors(r))
          : l6(Object(r)).forEach(function (t) {
              Object.defineProperty(
                e,
                t,
                Object.getOwnPropertyDescriptor(r, t)
  ...
  var A3 = i.forwardRef(function (e, n) {
    var r = e.children,
      t = e.className,
      a = p(e, B3);
    return o.jsx(
      ...
      u6(
        u6({}, a),
        {},
        { ref: n, className: l('utrecht-backdrop', t), children: r }
      )
    );
  });
  A3.displayName = 'Backdrop';
  var q3 = ['children', 'className', 'value'];
  function d6(e, n) {
    var r = Object.keys(e);
    if (Object.getOwnPropertySymbols) {
      var t = Object.getOwnPropertySymbols(e);
  ...
  var W3 = i.forwardRef(function (e, n) {
    var r = e.children,
      t = e.className,
      a = e.value,
      s = p(e, q3),
      u = i1({ children: r, className: l('utrecht-badge-counter', t) }, s);
    return typeof a < 'u'
      ? o.jsx('data', i1(i1({}, u), {}, { value: a, ref: n }))
      : o.jsx('span', i1(i1({}, u), {}, { ref: n }));
  });
  W3.displayName = 'BadgeCounter';
  var U3 = ['children', 'className'];
  function p6(e, n) {
    var r = Object.keys(e);
    if (Object.getOwnPropertySymbols) {
      var t = Object.getOwnPropertySymbols(e);
  ...
  function C6(e) {
    for (var n = 1; n < arguments.length; n++) {
      var r = arguments[n] != null ? arguments[n] : {};
      n % 2
        ? p6(Object(r), !0).forEach(function (t) {
            b(e, t, r[t]);
          })
        : Object.getOwnPropertyDescriptors
          ? Object.defineProperties(e, Object.getOwnPropertyDescriptors(r))
          : p6(Object(r)).forEach(function (t) {
              Object.defineProperty(
                e,
                t,
                Object.getOwnPropertyDescriptor(r, t)
  ...
  var Y3 = i.forwardRef(function (e, n) {
    var r = e.children,
      t = e.className,
      a = p(e, U3);
    return o.jsx(
      ...
      C6(
        C6({}, a),
        {},
        { ref: n, className: l('utrecht-badge-list', t), children: r }
      )
    );
  });
  Y3.displayName = 'BadgeList';
  var G3 = ['children', 'className', 'attribution'];
  function b6(e, n) {
    var r = Object.keys(e);
    if (Object.getOwnPropertySymbols) {
      var t = Object.getOwnPropertySymbols(e);
  ...
  var z3 = i.forwardRef(function (e, n) {
    ...
    return o.jsxs(
      ...
      f6(
        ...
        {
          ref: n,
          className: l('utrecht-blockquote', t),
          children: [
            r,
            a &&
              o.jsx('div', {
  ...
  var _1 = i.forwardRef(function (e, n) {
    var r = e.boxContent,
      t = e.children,
      a = e.className,
      s = e.external,
  ...
  _1.displayName = 'Link';
  var X3 = ['appearance', 'children', 'className', 'headingLevel', 'label'],
    Q3 = ['className', 'children'],
              ...
              o.jsx(
                ...
                k(
                  k(
                    ...
                    h6({ type: 'https://schema.org/BreadcrumbList' })
                  ),
                  {},
                  { children: t }
                )
  ...
  t7.displayName = 'BreadcrumbNav';
  var j6 = i.forwardRef(function (e, n) {
    var r = e.className,
      t = e.children,
      a = p(e, Q3);
    return o.jsx(
      ...
      k(
        k(
          k(
            { className: l('utrecht-breadcrumb-nav__item', r) },
            h6({ type: 'https://schema.org/ListItem', prop: 'itemListElement' })
          ),
          {},
          { ref: n },
          a
  ...
  j6.displayName = 'BreadcrumbNavItem';
  var n7 = i.forwardRef(function (e, n) {
    var r = e.className,
      t = e.children,
      a = p(e, e7);
    return o.jsx(
  ...
  n7.displayName = 'BreadcrumbNavSeparator';
  var a7 = i.forwardRef(function (e, n) {
    var r = e.children,
      t = e.disabled,
      a = e.current,
      s = e.href,
          ...
          {},
          {
            ...
            children: [
              o.jsx(
                'span',
                k(
                  k({ className: 'utrecht-breadcrumb-nav__text' }, V1('name')),
                  {},
                  { children: r }
                )
              ),
              typeof u == 'number'
                ? o.jsx(
                    'meta',
                    k(k({}, V1('position')), {}, { content: String(u + 1) })
                  )
                : null,
            ],
          }
  ...
  a7.displayName = 'BreadcrumbNavLink';
  var c7 = ['children', 'className', 'direction'];
  function g6(e, n) {
    var r = Object.keys(e);
    if (Object.getOwnPropertySymbols) {
      var t = Object.getOwnPropertySymbols(e);
  ...
  var o7 = function (n) {
      return (
        ...
        n.reduce(function (r, t) {
          return i.isValidElement(t) ? r + 1 : r;
        }, 0) >= 2
      );
    },
    i7 = i.forwardRef(function (e, n) {
      var r = e.children,
        t = e.className,
        a = e.direction,
        s = p(e, c7);
  ...
  var l7 = function (n) {
    ...
    w6 = i.forwardRef(function (e, n) {
      var r = e.appearance,
        ...
        y = m;
      return (
        O === 'button' && (y = m1(m1({}, m), {}, { onKeyDown: l7 })),
        o.jsx(
          'a',
          m1(
            m1(
              {
                ...
                className: l(
                  ...
                  'utrecht-button-link--html-a',
                  {
                    ...
                    'utrecht-button-link--placeholder': d,
                  },
                  a
                ),
                rel: s ? 'external noopener noreferrer' : void 0,
  ...
  var d7 = i.forwardRef(function (e, n) {
    var r = e.appearance,
      t = r === void 0 ? 'custom' : r,
      a = e.disabled,
      s = e.indeterminate,
    ...
    return (
      ...
      i.useEffect(
        function () {
          j.current && (j.current.indeterminate = u);
        },
        [u]
      ),
      o.jsx(
          ...
          {},
          {
            ...
            className: l(
              ...
              'utrecht-checkbox--html-input',
              {
                ...
                'utrecht-checkbox--invalid': d,
                'utrecht-checkbox--indeterminate': u,
                'utrecht-checkbox--required': O,
              },
              m
            ),
  ...
  var C7 = i.forwardRef(function (e, n) {
    var r = e.children,
      t = e.className,
      a = p(e, p7);
    return o.jsx(
      'code',
      D6(
        D6({ ref: n, className: l('utrecht-code', t) }, a),
        {},
        { children: r }
      )
    );
  ...
  var f7 = i.forwardRef(function (e, n) {
    var r = e.children,
      t = e.className,
      a = p(e, b7);
    return o.jsx(
      'pre',
      E6(
        E6({ ref: n, className: l('utrecht-code-block', t) }, a),
        {},
        {
          children: o.jsx('code', {
  ...
  f7.displayName = 'CodeBlock';
  var O7 = ['children', 'className', 'color', 'style'];
  function k6(e, n) {
    var r = Object.keys(e);
    if (Object.getOwnPropertySymbols) {
      var t = Object.getOwnPropertySymbols(e);
  ...
  var m7 = i.forwardRef(function (e, n) {
    var r = e.children,
      t = e.className,
      a = e.color,
      s = e.style,
    ...
    return o.jsx(
      ...
      y1(
        y1(
          {
            ref: n,
            className: l('utrecht-color-sample', t),
            style: y1(y1({}, s), {}, { color: a }),
            value: a,
          },
          u
        ),
  ...
  m7.displayName = 'ColorSample';
  var y7 = i.forwardRef(function (e, n) {
    var r = e.children,
      t = e.className,
      a = e.rule;
    return o.jsx('div', {
  ...
  y7.displayName = 'ColumnLayout';
  var h7 = ['className'],
    j7 = ['className', 'position'];
  function $6(e, n) {
    var r = Object.keys(e);
    if (Object.getOwnPropertySymbols) {
      var t = Object.getOwnPropertySymbols(e);
  ...
  var g7 = i.forwardRef(function (e, n) {
    var r = e.className,
      t = p(e, h7);
    return o.jsx(
      'div',
      h1(h1({ className: l('utrecht-combobox', r) }, t), {}, { ref: n })
    );
  });
  g7.displayName = 'Combobox';
  var v7 = i.forwardRef(function (e, n) {
    var r = e.className,
      t = e.position,
      a = p(e, j7);
    return o.jsx(
  ...
  v7.displayName = 'ComboboxPopover';
  var P7 = ['children', 'currency', 'amount', 'locale', 'className'];
  function M6(e, n) {
    var r = Object.keys(e);
    if (Object.getOwnPropertySymbols) {
      var t = Object.getOwnPropertySymbols(e);
  ...
  var w7 = function (n, r, t) {
    ...
    x7 = i.forwardRef(function (e, n) {
      var r = e.children,
        ...
        O = e.className,
        m = p(e, P7),
        y = typeof s == 'string' ? parseFloat(s) : s,
        j = w7(d, a, y),
        w = N7(d, a, y);
      return o.jsx(
        'data',
  ...
  x7.displayName = 'CurrencyData';
  var L7 = ['children', 'className', 'dateTime', 'value'];
  function _6(e, n) {
    var r = Object.keys(e);
    if (Object.getOwnPropertySymbols) {
      var t = Object.getOwnPropertySymbols(e);
  ...
  function F(e) {
    for (var n = 1; n < arguments.length; n++) {
      var r = arguments[n] != null ? arguments[n] : {};
      n % 2
        ? _6(Object(r), !0).forEach(function (t) {
            b(e, t, r[t]);
          })
        : Object.getOwnPropertyDescriptors
          ? Object.defineProperties(e, Object.getOwnPropertyDescriptors(r))
          : _6(Object(r)).forEach(function (t) {
              Object.defineProperty(
                e,
                t,
                Object.getOwnPropertyDescriptor(r, t)
  ...
  var D7 = i.forwardRef(function (e, n) {
    var r = e.children,
      ...
      s = e.value,
      u = p(e, L7),
      d = F({ children: r, className: l('utrecht-badge-data', t) }, u);
    return typeof a < 'u'
      ? o.jsx('time', F(F({}, d), {}, { dateTime: a, ref: n }))
      : typeof s < 'u'
        ? o.jsx('data', F(F({}, d), {}, { value: s, ref: n }))
        : o.jsx('span', F(F({}, d), {}, { ref: n }));
  });
  D7.displayName = 'DataBadge';
  var S7 = ['children', 'className'];
  function V6(e, n) {
    var r = Object.keys(e);
    if (Object.getOwnPropertySymbols) {
      var t = Object.getOwnPropertySymbols(e);
  ...
  var E7 = i.forwardRef(function (e, n) {
    var r = e.children,
      t = e.className,
      a = p(e, S7);
    return o.jsx(
      ...
      T6(
        T6({}, a),
        {},
        { ref: n, className: l('utrecht-document', t), children: r }
      )
    );
  });
  E7.displayName = 'Document';
  var k7 = ['appearance', 'children', 'className'],
    $7 = ['children', 'className'],
  ...
  var _7 = i.forwardRef(function (e, n) {
    var r = e.appearance,
      t = e.children,
      a = e.className,
      s = p(e, k7);
  ...
  var V7 = i.forwardRef(function (e, n) {
    ...
    return o.jsx(
      ...
      K(
        K({}, a),
        {},
        { className: l('utrecht-data-list__item', t), ref: n, children: r }
      )
    );
  });
  V7.displayName = 'DataListItem';
  var T7 = i.forwardRef(function (e, n) {
    var r = e.children,
      t = e.className,
      a = p(e, M7);
    return o.jsx(
      ...
      K(
        K({}, a),
        {},
        { className: l('utrecht-data-list__item-key', t), ref: n, children: r }
      )
    );
  });
  T7.displayName = 'DataListKey';
  var R7 = i.forwardRef(function (e, n) {
    var r = e.value,
      t = e.children,
      a = e.className,
    ...
    return o.jsx('dd', {
      className: l(
        ...
        a,
        u && 'utrecht-data-list__item-value--multiline'
      ),
      translate: typeof d == 'boolean' ? (d ? 'no' : 'yes') : void 0,
      ref: n,
      children: O ? o.jsx('span', { 'aria-label': s, children: '-' }) : t,
    });
  });
  R7.displayName = 'DataListValue';
  var K7 = i.forwardRef(function (e, n) {
    var r = e.children,
      t = e.className,
      a = p(e, H7);
    return o.jsx(
  ...
  K7.displayName = 'DataListActions';
  var Z7 = ['align', 'children', 'className', 'modal'];
  function K6(e, n) {
    var r = Object.keys(e);
    if (Object.getOwnPropertySymbols) {
      var t = Object.getOwnPropertySymbols(e);
  ...
  var I7 = i.forwardRef(function (e, n) {
    var r = e.align,
      t = e.children,
      a = e.className,
      s = e.modal,
    ...
    return (
      ...
      i.useEffect(function () {
        s &&
          ...
          d !== void 0 &&
          d.current &&
          (d.current.close(), d.current.showModal());
      }),
      o.jsx(
        'dialog',
        Z6(
  ...
  I7.displayName = 'Drawer';
  var F7 = ['children', 'className'];
  function I6(e, n) {
    var r = Object.keys(e);
    if (Object.getOwnPropertySymbols) {
      var t = Object.getOwnPropertySymbols(e);
  ...
  var B7 = i.forwardRef(function (e, n) {
    var r = e.children,
      t = e.className,
      a = p(e, F7);
    return o.jsx(
      ...
      F6(
        F6(
          {
            ref: n,
            className: l('utrecht-emphasis', 'utrecht-emphasis--stressed', t),
          },
          a
        ),
        {},
  ...
  var A7 = [
    ...
    q7 = ['className', 'children', 'disabled', 'invalid'];
  function B6(e, n) {
    var r = Object.keys(e);
    if (Object.getOwnPropertySymbols) {
      var t = Object.getOwnPropertySymbols(e);
  ...
  var W7 = i.forwardRef(function (e, n) {
      ...
      j1(
        ...
        {},
        {
          ...
          className: l(
            ...
            d && 'utrecht-form-fieldset--disabled',
  ...
  W7.displayName = 'Fieldset';
  var U7 = i.forwardRef(function (e, n) {
    var r = e.className,
      t = e.children,
      a = e.disabled,
      s = e.invalid,
  ...
  G7.displayName = 'FieldsetLegend';
  var z7 = ['className', 'children'];
  function W6(e, n) {
    var r = Object.keys(e);
    if (Object.getOwnPropertySymbols) {
      var t = Object.getOwnPropertySymbols(e);
  ...
  var J7 = i.forwardRef(function (e, n) {
    var r = e.className,
      t = e.children,
      a = p(e, z7);
    return o.jsx(
      ...
      U6(
        U6({}, a),
        {},
        { ref: n, className: l('utrecht-figure', r), children: t }
      )
    );
  });
  J7.displayName = 'Figure';
  ...
  var Q7 = i.forwardRef(function (e, n) {
    var r = e.className,
      t = e.children,
      a = p(e, X7);
    return o.jsx(
      ...
      G6(
        G6({}, a),
        {},
        { ref: n, className: l('utrecht-figure__caption', r), children: t }
      )
    );
  });
  Q7.displayName = 'FigureCaption';
  var e4 = [
    'className',
    'children',
    'description',
  ...
  var X6 = i.forwardRef(function (e, n) {
    var r = e.className,
      t = e.children,
      a = e.description,
      s = e.input,
  ...
  X6.displayName = 'FormField';
  var r4 = ['invalid', 'valid', 'warning', 'className', 'children'];
  function Q6(e, n) {
    var r = Object.keys(e);
    if (Object.getOwnPropertySymbols) {
      var t = Object.getOwnPropertySymbols(e);
  ...
  var re = i.forwardRef(function (e, n) {
    var r = e.invalid,
      t = e.valid,
      a = e.warning,
      s = e.className,
  ...
  re.displayName = 'FormFieldDescription';
  var t4 = ['className', 'children'];
  function te(e, n) {
    var r = Object.keys(e);
    if (Object.getOwnPropertySymbols) {
      var t = Object.getOwnPropertySymbols(e);
  ...
  var ae = i.forwardRef(function (e, n) {
    var r = e.className,
      t = e.children,
      a = p(e, t4);
    return o.jsx(
      ...
      ne(
        ...
        {
          ref: n,
          className: l('utrecht-form-field-error-message', r),
          children: t,
        }
      )
    );
  });
  ae.displayName = 'FormFieldErrorMessage';
  var n4 = ['children', 'className', 'type', 'disabled', 'checked'];
  function ce(e, n) {
    var r = Object.keys(e);
    if (Object.getOwnPropertySymbols) {
      var t = Object.getOwnPropertySymbols(e);
  ...
  var ie = i.forwardRef(function (e, n) {
    var r = e.children,
      t = e.className,
      a = e.type,
      s = e.disabled,
  ...
  var ue = i.forwardRef(function (e, n) {
    var r = e.dir,
      t = e.disabled,
      a = e.invalid,
      s = e.readOnly,
  ...
  var o4 = i.forwardRef(function (e, n) {
    var r = e.name,
      t = e.invalid,
      a = e.disabled,
      s = e.label,
    ...
    return o.jsxs(
      X6,
      pe(
        pe({ invalid: t, ref: n }, N1),
        {},
        {
          children: [
            o.jsx('div', {
              className: 'utrecht-form-field__label',
              children: o.jsx(ie, { htmlFor: l1, children: s }),
            }),
            d &&
              o.jsx(re, {
                className: 'utrecht-form-field__description',
  ...
  o4.displayName = 'FormFieldTextbox';
  var i4 = [
    'checked',
    'disabled',
    'invalid',
  ...
  var l4 = i.forwardRef(function (e, n) {
    var r = e.checked,
      t = e.disabled,
      a = e.invalid,
      s = e.id,
    ...
    return o.jsxs('div', {
      className: l(
        ...
        'utrecht-form-toggle--html-checkbox',
        {
          ...
          'utrecht-form-toggle--required': d,
        },
        y
      ),
      hidden: u,
  ...
  var d4 = i.forwardRef(function (e, n) {
    var r = e.children,
      t = e.className,
      a = p(e, u4);
    return o.jsx(
      ...
      fe(
        fe({}, a),
        {},
        { ref: n, className: l('utrecht-html', t), children: r }
      )
    );
  });
  d4.displayName = 'HTMLContent';
  ...
  var C4 = i.forwardRef(function (e, n) {
    var r = e.children,
      t = e.className,
      a = p(e, p4);
    return o.jsx(
      ...
      me(
        me({}, a),
        {},
        { ref: n, className: l('utrecht-heading-1', t), children: r }
      )
    );
  });
  C4.displayName = 'Heading1';
  ...
  var f4 = i.forwardRef(function (e, n) {
    var r = e.children,
      t = e.className,
      a = p(e, b4);
    return o.jsx(
      ...
      he(
        he({}, a),
        {},
        { ref: n, className: l('utrecht-heading-2', t), children: r }
      )
    );
  });
  f4.displayName = 'Heading2';
  ...
  var m4 = i.forwardRef(function (e, n) {
    var r = e.children,
      t = e.className,
      a = p(e, O4);
    return o.jsx(
      ...
      ge(
        ge({}, a),
        {},
        { ref: n, className: l('utrecht-heading-3', t), children: r }
      )
    );
  });
  m4.displayName = 'Heading3';
  ...
  var we = i.forwardRef(function (e, n) {
    var r = e.children,
      t = e.className,
      a = p(e, y4);
    return o.jsx(
      ...
      Pe(
        Pe({}, a),
        {},
        { ref: n, className: l('utrecht-heading-4', t), children: r }
      )
    );
  });
  we.displayName = 'Heading4';
  var h4 = ['children', 'className'];
  function Ne(e, n) {
    var r = Object.keys(e);
    if (Object.getOwnPropertySymbols) {
      var t = Object.getOwnPropertySymbols(e);
  ...
  var j4 = i.forwardRef(function (e, n) {
    var r = e.children,
      t = e.className,
      a = p(e, h4);
    return o.jsx(
      ...
      xe(
        xe({}, a),
        {},
        { ref: n, className: l('utrecht-heading-5', t), children: r }
      )
    );
  });
  j4.displayName = 'Heading5';
  var g4 = ['children', 'className'];
  function Le(e, n) {
    var r = Object.keys(e);
    if (Object.getOwnPropertySymbols) {
      var t = Object.getOwnPropertySymbols(e);
  ...
  var v4 = i.forwardRef(function (e, n) {
    var r = e.children,
      t = e.className,
      a = p(e, g4);
    return o.jsx(
      ...
      De(
        De({}, a),
        {},
        { ref: n, className: l('utrecht-heading-6', t), children: r }
      )
    );
  });
  v4.displayName = 'Heading6';
  var P4 = ['children', 'className'];
  function Se(e, n) {
    var r = Object.keys(e);
    if (Object.getOwnPropertySymbols) {
  ...
  var w4 = i.forwardRef(function (e, n) {
    var r = e.children,
      t = e.className,
      a = p(e, P4);
    return o.jsx(
      ...
      Ee(
        Ee({}, a),
        {},
        { ref: n, className: l('utrecht-heading-group', t), children: r }
      )
    );
  });
  w4.displayName = 'HeadingGroup';
  var N4 = ['children', 'value', 'className'];
  function ke(e, n) {
    var r = Object.keys(e);
    if (Object.getOwnPropertySymbols) {
      var t = Object.getOwnPropertySymbols(e);
      ...
      return o.jsx(
        ...
        $e(
          ...
          {},
          {
            ref: n,
            value: u,
            className: l('utrecht-iban-data', a),
            translate: 'no',
            children: r || d,
          }
        )
  ...
  D4.displayName = 'IBANData';
  var S4 = ['children', 'className'];
  function Me(e, n) {
    var r = Object.keys(e);
    if (Object.getOwnPropertySymbols) {
      var t = Object.getOwnPropertySymbols(e);
  ...
  var E4 = i.forwardRef(function (e, n) {
    var r = e.children,
      t = e.className,
      a = p(e, S4);
    return o.jsx(
      ...
      He(
        He(
          { 'aria-hidden': 'true', ref: n, className: l('utrecht-icon', t) },
          a
        ),
        {},
        { children: r }
  ...
  E4.displayName = 'Icon';
  var k4 = ['component', 'currentChar', 'characters', 'onLinkClick', 'Link'];
  function _e(e, n) {
    var r = Object.keys(e);
    if (Object.getOwnPropertySymbols) {
      var t = Object.getOwnPropertySymbols(e);
  ...
  var $4 = i.forwardRef(function (e, n) {
    var r = e.component,
      t = e.currentChar,
      a = e.characters,
      s = e.onLinkClick,
        ...
        ? (m = a.map(function (y) {
            ...
            return i.createElement(
              ...
              g1(
                ...
                {},
                {
                  className: l({ 'utrecht-index-char-nav__link--current': S }),
                  ref: n,
                  key: j,
                  appearance: S
                ...
                g1(
                  {
                    ...
                    appearance: u
                      ...
                      : E
                        ...
                        : 'secondary-action-button',
                    href: S,
                    className: l(u && Z, 'utrecht-index-char-nav__link', {
                      'utrecht-index-char-nav__link--disabled': w,
                      'utrecht-index-char-nav__link--current': E,
                    }),
                    'aria-current': E ? 'page' : void 0,
                    'aria-disabled': w,
                    placeholder: u ? void 0 : w,
                    onClick: function () {
                      return typeof s == 'function' && s(j);
                    },
                  },
  ...
  $4.displayName = 'IndexCharNav';
  var M4 = ['className', 'photo'];
  function Ve(e, n) {
    var r = Object.keys(e);
    if (Object.getOwnPropertySymbols) {
      var t = Object.getOwnPropertySymbols(e);
  ...
  var H4 = i.forwardRef(function (e, n) {
    var r = e.className,
      t = e.photo,
      a = p(e, M4);
    return o.jsx(
      ...
      Te(
        Te({}, a),
        {},
        { ref: n, className: l('utrecht-img', { 'utrecht-img--photo': t }, r) }
      )
    );
  });
  H4.displayName = 'Image';
  var _4 = ['children', 'disabled', 'inline', 'className', 'pressed', 'type'];
  function Re(e, n) {
    var r = Object.keys(e);
    if (Object.getOwnPropertySymbols) {
      var t = Object.getOwnPropertySymbols(e);
    ...
    return o.jsx(
      ...
      Ke(
        Ke(
          {
            ref: n,
            'aria-pressed': typeof u == 'boolean' ? u : void 0,
            className: l(
              'utrecht-link-button',
  ...
  V4.displayName = 'LinkButton';
  var T4 = ['children', 'className', 'external'];
  function Ze(e, n) {
    var r = Object.keys(e);
    if (Object.getOwnPropertySymbols) {
      var t = Object.getOwnPropertySymbols(e);
  ...
  var B = i.forwardRef(function (e, n) {
    ...
    return o.jsx(
      ...
      Ie(
        ...
        {
          ref: n,
          className: l('utrecht-link-social', t),
  ...
  B.displayName = 'LinkSocial';
  var R4 = ['className', 'icon', 'children'],
    K4 = ['children', 'icon', 'links', 'className'];
  function Fe(e, n) {
    var r = Object.keys(e);
    if (Object.getOwnPropertySymbols) {
      var t = Object.getOwnPropertySymbols(e);
  ...
  var Be = i.forwardRef(function (e, n) {
    var r = e.className,
      t = e.icon,
      a = e.children,
      s = p(e, R4);
    return o.jsx('li', {
      className: l('utrecht-link-list__item', r),
      children: o.jsxs(
        _1,
        s1(
          s1({ className: 'utrecht-link-list__link' }, s),
          {},
          {
            ref: n,
            children: [
  ...
  Be.displayName = 'LinkListLink';
  var Z4 = i.forwardRef(function (e, n) {
    var r = e.children,
      t = e.icon,
      a = e.links,
      s = e.className,
        ...
        s1(
          {
            role: 'list',
            ref: n,
            className: l('utrecht-link-list', 'utrecht-link-list--html-ul', s),
          },
          u
        ),
        {},
          ...
          children: [
            ...
            Array.isArray(a) &&
              a.map(function (d, O) {
                return o.jsx(
                  Be,
                  s1({ icon: typeof t == 'function' ? t() : void 0 }, d),
                  O
                );
              }),
          ],
  ...
  var I4 = [
    ...
    F4 = ['children', 'label'],
    B4 = ['active', 'className', 'disabled', 'selected'];
  function Ae(e, n) {
    var r = Object.keys(e);
    if (Object.getOwnPropertySymbols) {
      var t = Object.getOwnPropertySymbols(e);
  ...
  var A4 = i.forwardRef(function (e, n) {
    var r = e.children,
      t = e.className,
      a = e.disabled,
      s = e.invalid,
  ...
  A4.displayName = 'Listbox';
  var q4 = i.forwardRef(function (e, n) {
    var r = e.children,
      t = e.label,
      a = p(e, F4),
      s = i.useId();
  ...
  q4.displayName = 'ListboxOptionGroup';
  var W4 = i.forwardRef(function (e, n) {
    var r = e.active,
      t = e.className,
      a = e.disabled,
  ...
  var Y4 = i.forwardRef(function (e, n) {
    var r = e.children,
      t = e.className,
      a = p(e, U4);
    return o.jsx(
      'div',
      We(
        We({ ref: n, className: l('utrecht-logo', t) }, a),
        {},
        { children: r }
      )
    );
  ...
  var G4 = i.forwardRef(function (e, n) {
    var r = M1({}, (S3(e), e));
    return o.jsxs(
      'svg',
      Ye(
  ...
  var J4 = i.forwardRef(function (e, n) {
    ...
    return o.jsx(
      'mark',
      ze(
        ze({ ref: n, className: l('utrecht-mark', t) }, a),
        {},
        { children: r }
      )
    );
  ...
  Q4.displayName = 'MultilineData';
  var e9 = ['children', 'className', 'value'];
  function Qe(e, n) {
    var r = Object.keys(e);
    if (Object.getOwnPropertySymbols) {
      var t = Object.getOwnPropertySymbols(e);
  ...
  var r9 = i.forwardRef(function (e, n) {
    var r = e.children,
      t = e.className,
      a = e.value,
      s = p(e, e9);
    return o.jsx(
      ...
      e5(
        ...
        {},
        { ref: n, className: l('utrecht-number-data', t), children: r }
      )
    );
  });
  r9.displayName = 'NumberData';
  ...
  var n9 = i.forwardRef(function (e, n) {
    var r = e.children,
      t = e.className,
      a = p(e, t9);
    return o.jsx(
      ...
      t5(
        t5({}, a),
        {},
        { ref: n, className: l('utrecht-ordered-list', t), children: r }
      )
    );
  });
  n9.displayName = 'OrderedList';
  var a9 = ['children', 'className'];
  function n5(e, n) {
    var r = Object.keys(e);
    if (Object.getOwnPropertySymbols) {
      var t = Object.getOwnPropertySymbols(e);
  ...
  var c9 = i.forwardRef(function (e, n) {
    var r = e.children,
      t = e.className,
      a = p(e, a9);
    return o.jsx(
      ...
      a5(
        a5({}, a),
        {},
        { ref: n, className: l('utrecht-ordered-list__item', t), children: r }
      )
    );
  });
  c9.displayName = 'OrderedListItem';
  ...
  var i9 = i.forwardRef(function (e, n) {
    var r = e.children,
      t = e.className,
      a = p(e, o9);
    return o.jsx(
      ...
      o5(
        o5({}, a),
        {},
        { ref: n, className: l('utrecht-page', t), children: r }
      )
    );
  });
  i9.displayName = 'Page';
  var s9 = ['children', 'className'],
    l9 = ['children', 'className'];
  function i5(e, n) {
    var r = Object.keys(e);
    if (Object.getOwnPropertySymbols) {
      var t = Object.getOwnPropertySymbols(e);
  ...
  var u9 = i.forwardRef(function (e, n) {
    var r = e.children,
      t = e.className,
      a = p(e, s9);
    return o.jsx(
      ...
      v1(
        v1({}, a),
        {},
        { ref: n, className: l('utrecht-page-content', t), children: r }
      )
    );
  });
  u9.displayName = 'PageContent';
  var d9 = i.forwardRef(function (e, n) {
    var r = e.children,
      t = e.className,
      a = p(e, l9);
    return o.jsx(
      ...
      v1(
        v1({}, a),
        {},
        { ref: n, className: l('utrecht-page-content__main', t), children: r }
      )
    );
  });
  d9.displayName = 'PageContentMain';
  ...
  var C9 = i.forwardRef(function (e, n) {
    ...
    return o.jsx(
      ...
      l5(
        l5({}, a),
        {},
        { ref: n, className: l('utrecht-page-footer', t), children: r }
      )
    );
  });
  C9.displayName = 'PageFooter';
  var b9 = ['children', 'className'];
  function u5(e, n) {
    var r = Object.keys(e);
    if (Object.getOwnPropertySymbols) {
      var t = Object.getOwnPropertySymbols(e);
  ...
  var f9 = i.forwardRef(function (e, n) {
    var r = e.children,
      t = e.className,
      a = p(e, b9);
    return o.jsx(
      ...
      d5(
        d5({}, a),
        {},
        { ref: n, className: l('utrecht-page-header', t), children: r }
      )
    );
  });
  f9.displayName = 'PageHeader';
  var O9 = ['children', 'className', 'lead', 'small'];
  function p5(e, n) {
    var r = Object.keys(e);
    if (Object.getOwnPropertySymbols) {
      var t = Object.getOwnPropertySymbols(e);
  ...
  var m9 = i.forwardRef(function (e, n) {
    var r = e.children,
      t = e.className,
      a = e.lead,
      s = e.small,
  ...
  m9.displayName = 'Paragraph';
  var y9 = ['loading', 'className'];
  function b5(e, n) {
    var r = Object.keys(e);
    if (Object.getOwnPropertySymbols) {
      var t = Object.getOwnPropertySymbols(e);
  ...
  var j9 = i.forwardRef(function (e, n) {
    var r = e.loading,
      t = e.className,
      a = p(e, y9);
    return o.jsx(
  ...
  j9.displayName = 'DataPlaceholder';
  var g9 = ['children', 'className'];
  function f5(e, n) {
    var r = Object.keys(e);
    if (Object.getOwnPropertySymbols) {
      var t = Object.getOwnPropertySymbols(e);
  ...
  var v9 = i.forwardRef(function (e, n) {
    var r = e.children,
      t = e.className,
      a = p(e, g9);
    return o.jsx(
      ...
      O5(
        O5({}, a),
        {},
        { ref: n, className: l('utrecht-pre-heading', t), children: r }
      )
    );
  });
  v9.displayName = 'PreHeading';
  var P9 = ['children', 'className', 'dateTime', 'value'];
  function m5(e, n) {
    var r = Object.keys(e);
    if (Object.getOwnPropertySymbols) {
      var t = Object.getOwnPropertySymbols(e);
  ...
  var w9 = i.forwardRef(function (e, n) {
    var r = e.children,
      t = e.className,
      a = e.dateTime,
      s = e.value,
      ...
      d = A(
        {
          ...
          className: l('utrecht-preserve-data', t),
        },
        u
      );
    return typeof a < 'u'
      ? o.jsx('time', A(A({}, d), {}, { dateTime: a, ref: n }))
      : typeof s < 'u'
        ? o.jsx('data', A(A({}, d), {}, { value: s, ref: n }))
        : o.jsx(
            'bdi',
            A(A({ translate: 'no', ref: n }, d), {}, { children: r })
          );
  });
  w9.displayName = 'PreserveData';
  var N9 = ['disabled', 'required', 'className', 'invalid'];
  function y5(e, n) {
    var r = Object.keys(e);
    if (Object.getOwnPropertySymbols) {
      var t = Object.getOwnPropertySymbols(e);
  ...
  var L9 = i.forwardRef(function (e, n) {
    var r = e.disabled,
      t = e.required,
      a = e.className,
      s = e.invalid,
  ...
  L9.displayName = 'RadioButton';
  var D9 = ['className', 'children'];
  function h5(e, n) {
    var r = Object.keys(e);
    if (Object.getOwnPropertySymbols) {
      var t = Object.getOwnPropertySymbols(e);
  ...
  var S9 = i.forwardRef(function (e, n) {
    var r = e.className,
      t = e.children,
      a = p(e, D9);
    return o.jsx(
      ...
      j5(
        j5({}, a),
        {},
        { ref: n, className: l('utrecht-rich-text', r), children: t }
      )
    );
  });
  S9.displayName = 'RichText';
  var E9 = ['busy', 'invalid', 'required', 'className', 'noscript', 'children'],
    k9 = ['disabled', 'invalid', 'value', 'children', 'className'];
  function g5(e, n) {
    var r = Object.keys(e);
    if (Object.getOwnPropertySymbols) {
      var t = Object.getOwnPropertySymbols(e);
  ...
  var $9 = i.forwardRef(function (e, n) {
    var r = e.busy,
      t = e.invalid,
      a = e.required,
      s = e.className,
        ...
        P1(
          {
            ...
            required: u ? a : !1,
            'aria-required': u ? void 0 : a || void 0,
            className: l(
              'utrecht-select',
  ...
  M9.displayName = 'SelectOption';
  var H9 = ['className', 'children'];
  function v5(e, n) {
    var r = Object.keys(e);
    if (Object.getOwnPropertySymbols) {
      var t = Object.getOwnPropertySymbols(e);
  ...
  var _9 = i.forwardRef(function (e, n) {
    var r = e.className;
    e.children;
    var t = p(e, H9);
    return o.jsx(
      'hr',
      P5(P5({}, t), {}, { ref: n, className: l('utrecht-separator', r) })
    );
  });
  _9.displayName = 'Separator';
  var V9 = ['children', 'className'];
  function w5(e, n) {
    var r = Object.keys(e);
    if (Object.getOwnPropertySymbols) {
      var t = Object.getOwnPropertySymbols(e);
  ...
  var T9 = i.forwardRef(function (e, n) {
    var r = e.children,
      t = e.className,
      a = p(e, V9);
    return o.jsx('p', {
  ...
  T9.displayName = 'SkipLink';
  var R9 = ['aside', 'children', 'className', 'type'];
  function x5(e, n) {
    var r = Object.keys(e);
    if (Object.getOwnPropertySymbols) {
      var t = Object.getOwnPropertySymbols(e);
  ...
  var K9 = i.forwardRef(function (e, n) {
    var r = e.aside,
      t = e.children,
      a = e.className,
      s = e.type,
    ...
    return r
      ? o.jsx('aside', J(J({}, d), {}, { children: t }))
      : o.jsx('section', J(J({}, d), {}, { children: t }));
  });
  K9.displayName = 'SpotlightSection';
  var Z9 = ['className', 'status'];
  function L5(e, n) {
    var r = Object.keys(e);
    if (Object.getOwnPropertySymbols) {
      var t = Object.getOwnPropertySymbols(e);
  ...
  I9.displayName = 'StatusBadge';
  var F9 = ['children', 'className'];
  function S5(e, n) {
    var r = Object.keys(e);
    if (Object.getOwnPropertySymbols) {
      var t = Object.getOwnPropertySymbols(e);
  ...
  var B9 = i.forwardRef(function (e, n) {
    var r = e.children,
      t = e.className,
      a = p(e, F9);
    return o.jsx(
      ...
      E5(
        E5(
          {
            ref: n,
            className: l('utrecht-emphasis', 'utrecht-emphasis--strong', t),
          },
          a
        ),
        {},
  ...
  var q9 = i.forwardRef(function (e, n) {
    var r = e.children,
      t = e.className,
      a = p(e, A9);
    return o.jsx(
      ...
      $5(
        $5({}, a),
        {},
        { ref: n, className: l('utrecht-surface', t), children: r }
      )
    );
  });
  q9.displayName = 'Surface';
  var W9 = ['overflowInline', 'children', 'className'];
  function M5(e, n) {
    var r = Object.keys(e);
    if (Object.getOwnPropertySymbols) {
      var t = Object.getOwnPropertySymbols(e);
  ...
  U9.displayName = 'TableContainer';
  var Y9 = ['busy', 'children', 'className'];
  function _5(e, n) {
    var r = Object.keys(e);
    if (Object.getOwnPropertySymbols) {
      var t = Object.getOwnPropertySymbols(e);
  ...
  var G9 = i.forwardRef(function (e, n) {
    var r = e.busy,
      t = e.children,
      a = e.className,
      s = p(e, Y9);
    return o.jsx(
      ...
      V5(
        ...
        {
          ref: n,
          className: l('utrecht-table', { 'utrecht-table--busy': r }, a),
          children: t,
        }
      )
    );
  });
  G9.displayName = 'Table';
  ...
  var J9 = i.forwardRef(function (e, n) {
    ...
    return o.jsx(
      ...
      R5(
        R5({}, a),
        {},
        { ref: n, className: l('utrecht-table__body', t), children: r }
      )
    );
  });
  J9.displayName = 'TableBody';
  var X9 = ['children', 'className'];
  function K5(e, n) {
    var r = Object.keys(e);
    if (Object.getOwnPropertySymbols) {
      var t = Object.getOwnPropertySymbols(e);
  ...
  var Q9 = i.forwardRef(function (e, n) {
    ...
    return o.jsx(
      ...
      Z5(
        Z5({}, a),
        {},
        { ref: n, className: l('utrecht-table__caption', t), children: r }
      )
    );
  });
  Q9.displayName = 'TableCaption';
  var e8 = ['children', 'className', 'numericColumn', 'selected'];
  function I5(e, n) {
    var r = Object.keys(e);
    if (Object.getOwnPropertySymbols) {
      var t = Object.getOwnPropertySymbols(e);
  ...
  var r8 = i.forwardRef(function (e, n) {
    var r = e.children,
      t = e.className,
      a = e.numericColumn,
      s = e.selected,
  ...
  r8.displayName = 'TableCell';
  var t8 = ['children', 'className', 'sticky'];
  function B5(e, n) {
    var r = Object.keys(e);
    if (Object.getOwnPropertySymbols) {
      var t = Object.getOwnPropertySymbols(e);
  ...
  var n8 = i.forwardRef(function (e, n) {
    var r = e.children,
      t = e.className,
      a = e.sticky,
      s = p(e, t8);
  ...
  n8.displayName = 'TableFooter';
  var a8 = ['children', 'className', 'sticky'];
  function q5(e, n) {
    var r = Object.keys(e);
    if (Object.getOwnPropertySymbols) {
      var t = Object.getOwnPropertySymbols(e);
  ...
  var c8 = i.forwardRef(function (e, n) {
    var r = e.children,
      t = e.className,
      a = e.sticky,
      s = p(e, a8);
  ...
  var i8 = i.forwardRef(function (e, n) {
    var r = e.children,
      t = e.className,
      a = e.numericColumn,
      s = e.selected,
    ...
    return o.jsx(
      'th',
      Y5(
        Y5({ 'aria-selected': s ? !0 : void 0, scope: d }, O),
        {},
        {
          ref: n,
          className: l(
            'utrecht-table__header-cell',
            {
              ...
              'utrecht-table__header-cell--sticky-inline': u && d === 'row',
              'utrecht-table__header-cell--sticky-block': u && d === 'col',
            },
            t
          ),
          children: r,
  ...
  i8.displayName = 'TableHeaderCell';
  var s8 = ['children', 'className', 'selected'];
  function G5(e, n) {
    var r = Object.keys(e);
    if (Object.getOwnPropertySymbols) {
      var t = Object.getOwnPropertySymbols(e);
  ...
  var l8 = i.forwardRef(function (e, n) {
    var r = e.children,
      t = e.className,
      a = e.selected,
      s = p(e, s8);
  ...
  l8.displayName = 'TableRow';
  var u8 = ['dir', 'disabled', 'invalid', 'readOnly', 'required', 'className'];
  function J5(e, n) {
    var r = Object.keys(e);
    if (Object.getOwnPropertySymbols) {
      var t = Object.getOwnPropertySymbols(e);
  ...
  var d8 = i.forwardRef(function (e, n) {
    var r = e.dir,
      t = e.disabled,
      a = e.invalid,
      s = e.readOnly,
  ...
  d8.displayName = 'Textarea';
  var p8 = ['children', 'className'];
  function Q5(e, n) {
    var r = Object.keys(e);
    if (Object.getOwnPropertySymbols) {
      var t = Object.getOwnPropertySymbols(e);
  ...
  var C8 = i.forwardRef(function (e, n) {
    ...
    return o.jsx(
      ...
      e3(
        e3({ translate: 'no' }, a),
        {},
        { ref: n, className: l('utrecht-url-data', t), children: r }
      )
    );
  });
  C8.displayName = 'URLData';
  var b8 = ['children', 'className'];
  function r3(e, n) {
    var r = Object.keys(e);
    if (Object.getOwnPropertySymbols) {
      var t = Object.getOwnPropertySymbols(e);
  ...
  var f8 = i.forwardRef(function (e, n) {
    var r = e.children,
      t = e.className,
      a = p(e, b8);
    return o.jsx(
      ...
      t3(
        t3({ role: 'list' }, a),
        {},
        { ref: n, className: l('utrecht-unordered-list', t), children: r }
      )
    );
  });
  f8.displayName = 'UnorderedList';
  ...
  var m8 = i.forwardRef(function (e, n) {
    var r = e.children,
      t = e.className,
      a = p(e, O8);
    return o.jsx(
      ...
      a3(
        a3({}, a),
        {},
        { ref: n, className: l('utrecht-unordered-list__item', t), children: r }
      )
    );
  });
  m8.displayName = 'UnorderedListItem';
  function c3({ title: e }) {
    return i.createElement(
      'div',
      { className: 'share-links' },
      i.createElement(we, null, e),
      i.createElement(
        'div',
        ...
        i.createElement(
          ...
          i.createElement('i', { className: 'icon --facebook' }),
          i.createElement('span', { className: 'sr-only' }, 'Facebook')
        ),
        i.createElement(
          B,
          {
          ...
          i.createElement('i', { className: 'icon --twitter' }),
          i.createElement('span', { className: 'sr-only' }, 'X')
        ),
        i.createElement(
          B,
          {
          ...
          i.createElement('i', { className: 'icon --mail' }),
          i.createElement('span', { className: 'sr-only' }, 'Mail')
        ),
        i.createElement(
          B,
          {
          ...
          i.createElement('i', { className: 'icon --whatsapp' }),
          i.createElement('span', { className: 'sr-only' }, 'Whatsapp')
        ),
        i.createElement(
          B,
          {
          ...
          i.createElement('i', { className: 'icon --linkedin' }),
          i.createElement('span', { className: 'sr-only' }, 'LinkedIn')
        ),
        i.createElement(
          B,
          {
          ...
          i.createElement('i', { className: 'icon --url' }),
          i.createElement('span', { className: 'sr-only' }, 'Kopieer link')
        )
      )
    );
  }
  return (
    (c3.loadWidgetOnElement = function (e, n) {
      const r = this;
      e && k1(e).render(i.createElement(r, { ...n }));
    }),
    (E1.ShareLinks = c3),
    Object.defineProperty(E1, Symbol.toStringTag, { value: 'Module' }),
    E1
  );
})({}, React, ReactDOM);
