var NavBar = (function (k1, s, v3) {
  ...
  function P3() {
    ...
    if (process.env.NODE_ENV === 'production')
      ((J.createRoot = e.createRoot), (J.hydrateRoot = e.hydrateRoot));
    else {
      var n = e.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED;
      ((J.createRoot = function (r, t) {
        n.usingClientEntryPoint = !0;
        try {
          return e.createRoot(r, t);
        } finally {
          n.usingClientEntryPoint = !1;
        }
      }),
        (J.hydrateRoot = function (r, t, a) {
          n.usingClientEntryPoint = !0;
          try {
            return e.hydrateRoot(r, t, a);
          } finally {
            n.usingClientEntryPoint = !1;
          }
        }));
  ...
  function D3() {
    ...
    function l(u, f, m) {
      ...
      for (y in f) t.call(f, y) && !i.hasOwnProperty(y) && (j[y] = f[y]);
      if (u && u.defaultProps)
        for (y in ((f = u.defaultProps), f)) j[y] === void 0 && (j[y] = f[y]);
      return {
        $$typeof: n,
        type: u,
        key: w,
    ...
    return ((s1.Fragment = r), (s1.jsx = l), (s1.jsxs = l), s1);
  }
  var l1 = {};
  /**
   * @license React
      ...
      Y1 ||
        ...
        process.env.NODE_ENV !== 'production' &&
          (function () {
            ...
            function r1(c, C, O) {
              {
                var h = H.ReactDebugCurrentFrame,
                  P = h.getStackAddendum();
                P !== '' && ((C += '%s'), (O = O.concat([P])));
                var N = O.map(function (v) {
                  return String(v);
                });
                (N.unshift('Warning: ' + C),
                  Function.prototype.apply.call(console[c], console, N));
              }
            }
            var q = !1,
              t1 = !1,
            ...
            function V(c) {
              ...
              if (typeof c == 'object')
                switch (c.$$typeof) {
                  case u:
                    var C = c;
                    return x1(C) + '.Consumer';
                  case l:
                    var O = c;
                    return x1(O._context) + '.Provider';
                  case f:
                    return T1(c, c.render, 'ForwardRef');
                  case j:
                    var h = c.displayName || null;
                    return h !== null ? h : V(c.type) || 'Memo';
                  case w: {
                    var P = c,
                      N = P._payload,
                      v = P._init;
            ...
            function w8() {
              {
                if ((Y--, Y === 0)) {
                  ...
                  Object.defineProperties(console, {
                    ...
                    error: T({}, c, { value: b1 }),
                    group: T({}, c, { value: f1 }),
                    groupCollapsed: T({}, c, { value: a3 }),
                    groupEnd: T({}, c, { value: c3 }),
                  });
                }
                Y < 0 &&
                  D(
            ...
            var R1 = H.ReactCurrentDispatcher,
              K1;
            function D1(c, C, O) {
              {
                if (K1 === void 0)
...
` +
            ...
            var Z1 = !1,
              S1;
            {
              var N8 = typeof WeakMap == 'function' ? WeakMap : Map;
              S1 = new N8();
            }
            function i3(c, C) {
              if (!c || Z1) return '';
              ...
              var N;
              ((N = R1.current), (R1.current = null), P8());
              try {
                if (C) {
                  var v = function () {
                    throw Error();
...
` + g[x].replace(' at new ', ' at ');
                            return (
                              c.displayName &&
                                ...
                                (M = M.replace('<anonymous>', c.displayName)),
                              typeof c == 'function' && S1.set(c, M),
                              M
                            );
                          }
                        while (x >= 1 && L >= 0);
              ...
              var o1 = c ? c.displayName || c.name : '',
                G = o1 ? D1(o1) : '';
              return (typeof c == 'function' && S1.set(c, G), G);
            }
            function x8(c, C, O) {
              return i3(c, !1);
            }
            ...
            function E1(c, C, O) {
              if (c == null) return '';
              if (typeof c == 'function') return i3(c, L8(c));
              if (typeof c == 'string') return D1(c);
              switch (c) {
                case m:
                  return D1('Suspense');
                case y:
            ...
            var O1 = Object.prototype.hasOwnProperty,
              s3 = {},
              l3 = H.ReactDebugCurrentFrame;
            function $1(c) {
              if (c) {
                var C = c._owner,
                  O = E1(c.type, c._source, C ? C.type : null);
                l3.setExtraStackFrame(O);
              } else l3.setExtraStackFrame(null);
            }
            function D8(c, C, O, h, P) {
              {
                var N = Function.call.bind(O1);
                for (var v in c)
                  if (N(c, v)) {
                    var g = void 0;
                    try {
            ...
            function H8(c, C) {
              typeof c.ref == 'string' && p3.current;
            }
            function V8(c, C) {
              {
                var O = function () {
            ...
            function K8(c, C, O, h, P) {
              {
                var N,
                  ...
                  k = null;
                (O !== void 0 && (d3(O), (g = '' + O)),
                  M8(C) && (d3(C.key), (g = '' + C.key)),
                  _8(C) && ((k = C.ref), H8(C, P)));
                for (N in C)
                  O1.call(C, N) && !k8.hasOwnProperty(N) && (v[N] = C[N]);
                if (c && c.defaultProps) {
                  var x = c.defaultProps;
                  for (N in x) v[N] === void 0 && (v[N] = x[N]);
                }
                if (g || k) {
                  var L =
                    typeof c == 'function'
                ...
                return R8(c, g, k, P, h, p3.current, v);
              }
            }
            var I1 = H.ReactCurrentOwner,
              f3 = H.ReactDebugCurrentFrame;
            function c1(c) {
              if (c) {
                var C = c._owner,
                  O = E1(c.type, c._source, C ? C.type : null);
                f3.setExtraStackFrame(O);
              } else f3.setExtraStackFrame(null);
            }
            var B1;
            B1 = !1;
            function A1(c) {
...
Check the top-level render call using <` +
            ...
            function y3(c, C) {
              {
                ...
                (c &&
                  c._owner &&
                  c._owner !== I1.current &&
                  (h = ' It was passed a child from ' + V(c._owner.type) + '.'),
                  c1(c),
                  D(
            ...
            function h3(c, C) {
              {
                ...
                else if (A1(c)) c._store && (c._store.validated = !0);
                else if (c) {
                  var P = F(c);
                  if (typeof P == 'function' && P !== c.entries)
                    for (var N = P.call(c), v; !(v = N.next()).done; )
                      A1(v.value) && y3(v.value, C);
                }
              }
            }
            function I8(c) {
              {
                ...
                var O;
                if (typeof C == 'function') O = C.propTypes;
                else if (
                  typeof C == 'object' &&
                  (C.$$typeof === f || C.$$typeof === j)
                )
                  O = C.propTypes;
                else return;
                if (O) {
                  var h = V(C);
                  D8(O, c.props, 'prop', h, c);
                } else if (C.PropTypes !== void 0 && !B1) {
                  B1 = !0;
                  var P = V(C);
                  D(
            ...
            function B8(c) {
              {
                for (var C = Object.keys(c.props), O = 0; O < C.length; O++) {
                  var h = C[O];
                  if (h !== 'children' && h !== 'key') {
                    (c1(c),
                      D(
            ...
            function g3(c, C, O, h, P, N) {
              {
                ...
                if (v) {
                  ...
                  if (M !== void 0)
                    if (h)
                      if (F1(M)) {
                        for (var o1 = 0; o1 < M.length; o1++) h3(M[o1], c);
                ...
                if (O1.call(C, 'key')) {
                  var G = V(c),
                    _ = Object.keys(C).filter(function (G8) {
                      return G8 !== 'key';
                    }),
                    q1 =
                      _.length > 0
...
React keys must be passed directly to JSX without using spread:
  ...
  <%s key={someKey} {...props} />`,
            ...
            var W8 = q8,
              U8 = A8;
            ((l1.Fragment = t), (l1.jsx = W8), (l1.jsxs = U8));
          })()),
      l1
    );
  }
  ...
  function J1(e) {
    ...
    if (typeof e == 'string' || typeof e == 'number') t += e;
      ...
      if (Array.isArray(e)) {
        var a = e.length;
        for (n = 0; n < a; n++)
          e[n] && (r = J1(e[n])) && (t && (t += ' '), (t += r));
      } else for (r in e) e[r] && (t && (t += ' '), (t += r));
    return t;
  }
  function d() {
    for (var e, n, r = 0, t = '', a = arguments.length; r < a; r++)
      (e = arguments[r]) && (n = J1(e)) && (t && (t += ' '), (t += n));
    return t;
  }
  function $3(e) {
  ...
  function X1(e) {
    for (var n = 1; n < arguments.length; n++) {
      ...
      n % 2
        ? z1(Object(r), !0).forEach(function (t) {
            b(e, t, r[t]);
          })
        : Object.getOwnPropertyDescriptors
          ? Object.defineProperties(e, Object.getOwnPropertyDescriptors(r))
          : z1(Object(r)).forEach(function (t) {
  ...
  var M1 = s.forwardRef(function (e, n) {
    var r = e.appearance,
      t = e.busy,
      a = e.disabled,
      i = e.children,
        ...
        X1(
          {
            ...
            className: d(
              ...
              m === 'submit' && 'utrecht-button--submit',
              ...
              u === 'danger' && 'utrecht-button--danger',
              u === 'warning' && 'utrecht-button--warning',
              u === 'ready' && 'utrecht-button--ready',
              f === !0 && 'utrecht-button--pressed',
              l
            ),
            'aria-busy': t || void 0,
            'aria-pressed': typeof f == 'boolean' ? f : void 0,
            disabled: a,
            type: m || 'button',
          },
          y
  ...
  var _3 = ['appearance', 'className', 'level'];
  function Q1(e, n) {
    var r = Object.keys(e);
    if (Object.getOwnPropertySymbols) {
      var t = Object.getOwnPropertySymbols(e);
  ...
  function e6(e) {
    for (var n = 1; n < arguments.length; n++) {
      var r = arguments[n] != null ? arguments[n] : {};
      n % 2
        ? Q1(Object(r), !0).forEach(function (t) {
            b(e, t, r[t]);
          })
        : Object.getOwnPropertyDescriptors
          ? Object.defineProperties(e, Object.getOwnPropertyDescriptors(r))
          : Q1(Object(r)).forEach(function (t) {
              Object.defineProperty(
                e,
                t,
                Object.getOwnPropertyDescriptor(r, t)
  ...
  var y1 = s.forwardRef(function (e, n) {
    var r = e.appearance,
      t = e.className,
      a = e.level,
      i = p(e, _3),
            ...
            : a === 4
              ...
              : a === 5
                ...
                : a === 6
                  ? 'h6'
                  : 'h1',
      f = r && l.indexOf(r) !== -1 ? r : l[a - 1] || 'utrecht-heading-1';
    return o.jsx(u, e6(e6({ className: d(f, t) }, i), {}, { ref: n }));
  });
  y1.displayName = 'Heading';
  var M3 = [
      'id',
      'label',
      'className',
    ...
    H3 = ['children', 'group', 'headingLevel', 'heading'];
  function r6(e, n) {
    var r = Object.keys(e);
    if (Object.getOwnPropertySymbols) {
      var t = Object.getOwnPropertySymbols(e);
  ...
  function R(e) {
    for (var n = 1; n < arguments.length; n++) {
      var r = arguments[n] != null ? arguments[n] : {};
      n % 2
        ? r6(Object(r), !0).forEach(function (t) {
            b(e, t, r[t]);
          })
        : Object.getOwnPropertyDescriptors
          ? Object.defineProperties(e, Object.getOwnPropertyDescriptors(r))
          : r6(Object(r)).forEach(function (t) {
              Object.defineProperty(
                e,
                t,
                Object.getOwnPropertyDescriptor(r, t)
  ...
  var V3 = function () {
    ...
    T3 = s.forwardRef(function (e, n) {
      var r = e.id,
        ...
        D = p(e, M3),
        r1 = {
          className: d('utrecht-accordion__panel', {
            'utrecht-accordion__panel--expanded': f,
          }),
          hidden: !f,
          'aria-hidden': !f,
        },
        q = F || (F === null ? null : o.jsx(V3, {}));
      H === 'utrecht' && (q = null);
      var t1 = 'utrecht-accordion',
        n1 = r || s.useId(),
        a1 = ''.concat(t1).concat(n1, '-button'),
        W = ''.concat(t1).concat(n1, '-panel');
      return o.jsxs(
        'div',
        R(
          R(
            { className: d('utrecht-accordion__section', a), id: r, ref: n },
            D
          ),
          {},
          {
            children: [
              o.jsx(y1, {
                level: l,
                className: d('utrecht-accordion__header'),
                children: o.jsxs(M1, {
                  className: d(
                    'utrecht-accordion__button',
                    b({}, 'utrecht-accordion__button--utrecht', H === 'utrecht')
                  ),
              ...
              y
                ? o.jsx(
                    'section',
                    R(
                      R({ id: W, 'aria-labelledby': a1 }, r1),
                      {},
                      { children: j }
                    )
                  )
                : o.jsx('div', R(R({ id: W }, r1), {}, { children: j })),
            ],
          }
        )
      );
    });
  T3.displayName = 'AccordionSection';
  var R3 = s.forwardRef(function (e, n) {
    var r = e.children,
      t = e.group,
      a = e.headingLevel,
      i = e.heading,
    ...
    return o.jsxs(o.Fragment, {
      children: [
        !!i && typeof a == 'number' && o.jsx(y1, { level: a, children: i }),
        o.jsx(
          'div',
          R(
            R(
              {
                className: d('utrecht-accordion'),
                role: t ? 'group' : void 0,
  ...
  R3.displayName = 'Accordion';
  var K3 = ['children', 'className', 'icon', 'type'];
  function t6(e, n) {
    var r = Object.keys(e);
    if (Object.getOwnPropertySymbols) {
      var t = Object.getOwnPropertySymbols(e);
  ...
  var Z3 = s.forwardRef(function (e, n) {
    var r = e.children,
      t = e.className,
      a = e.icon,
      i = e.type,
      ...
      n6(
        ...
        {},
        {
          ...
          className: d(
            'utrecht-alert',
            {
              'utrecht-alert--error': i === 'error',
              'utrecht-alert--info': i === 'info',
              'utrecht-alert--ok': i === 'ok',
              'utrecht-alert--warning': i === 'warning',
            },
            t
          ),
          children: [
            a &&
              o.jsx('div', { className: 'utrecht-alert__icon', children: a }),
            o.jsx('div', { className: 'utrecht-alert__message', children: r }),
          ],
        }
      )
    );
  });
  Z3.displayName = 'Alert';
  var F3 = ['children', 'className', 'icon', 'type'];
  function a6(e, n) {
    var r = Object.keys(e);
    if (Object.getOwnPropertySymbols) {
      var t = Object.getOwnPropertySymbols(e);
  ...
  var I3 = s.forwardRef(function (e, n) {
    var r = e.children,
      t = e.className,
      a = e.icon,
      i = e.type,
    ...
    return o.jsxs(
      ...
      c6(
        ...
        {
          ref: n,
          className: d('utrecht-alert-dialog', {
            'utrecht-alert-dialog--error': i === 'error',
            'utrecht-alert-dialog--info': i === 'info',
  ...
  I3.displayName = 'AlertDialog';
  var B3 = ['children', 'className'];
  function o6(e, n) {
    var r = Object.keys(e);
    if (Object.getOwnPropertySymbols) {
      var t = Object.getOwnPropertySymbols(e);
  ...
  function i6(e) {
    for (var n = 1; n < arguments.length; n++) {
      var r = arguments[n] != null ? arguments[n] : {};
      n % 2
        ? o6(Object(r), !0).forEach(function (t) {
            b(e, t, r[t]);
          })
        : Object.getOwnPropertyDescriptors
          ? Object.defineProperties(e, Object.getOwnPropertyDescriptors(r))
          : o6(Object(r)).forEach(function (t) {
              Object.defineProperty(
                e,
                t,
                Object.getOwnPropertyDescriptor(r, t)
  ...
  var A3 = s.forwardRef(function (e, n) {
    var r = e.children,
      t = e.className,
      a = p(e, B3);
    return o.jsx(
      ...
      i6(
        i6({}, a),
        {},
        { ref: n, className: d('utrecht-article', t), children: r }
      )
    );
  });
  A3.displayName = 'Article';
  ...
  function l6(e) {
    for (var n = 1; n < arguments.length; n++) {
      var r = arguments[n] != null ? arguments[n] : {};
      n % 2
        ? s6(Object(r), !0).forEach(function (t) {
            b(e, t, r[t]);
          })
        : Object.getOwnPropertyDescriptors
          ? Object.defineProperties(e, Object.getOwnPropertyDescriptors(r))
          : s6(Object(r)).forEach(function (t) {
              Object.defineProperty(
                e,
                t,
                Object.getOwnPropertyDescriptor(r, t)
  ...
  var W3 = s.forwardRef(function (e, n) {
    var r = e.children,
      t = e.className,
      a = p(e, q3);
    return o.jsx(
      ...
      l6(
        l6({}, a),
        {},
        { ref: n, className: d('utrecht-backdrop', t), children: r }
      )
    );
  });
  W3.displayName = 'Backdrop';
  var U3 = ['children', 'className', 'value'];
  function u6(e, n) {
    var r = Object.keys(e);
    if (Object.getOwnPropertySymbols) {
      var t = Object.getOwnPropertySymbols(e);
  ...
  function u1(e) {
    for (var n = 1; n < arguments.length; n++) {
      var r = arguments[n] != null ? arguments[n] : {};
      n % 2
        ? u6(Object(r), !0).forEach(function (t) {
            b(e, t, r[t]);
          })
        : Object.getOwnPropertyDescriptors
          ? Object.defineProperties(e, Object.getOwnPropertyDescriptors(r))
          : u6(Object(r)).forEach(function (t) {
              Object.defineProperty(
                e,
                t,
                Object.getOwnPropertyDescriptor(r, t)
  ...
  var Y3 = s.forwardRef(function (e, n) {
    var r = e.children,
      t = e.className,
      a = e.value,
      i = p(e, U3),
      l = u1({ children: r, className: d('utrecht-badge-counter', t) }, i);
    return typeof a < 'u'
      ? o.jsx('data', u1(u1({}, l), {}, { value: a, ref: n }))
      : o.jsx('span', u1(u1({}, l), {}, { ref: n }));
  });
  Y3.displayName = 'BadgeCounter';
  var G3 = ['children', 'className'];
  function d6(e, n) {
    var r = Object.keys(e);
    if (Object.getOwnPropertySymbols) {
      var t = Object.getOwnPropertySymbols(e);
  ...
  function p6(e) {
    for (var n = 1; n < arguments.length; n++) {
      var r = arguments[n] != null ? arguments[n] : {};
      n % 2
        ? d6(Object(r), !0).forEach(function (t) {
            b(e, t, r[t]);
          })
        : Object.getOwnPropertyDescriptors
          ? Object.defineProperties(e, Object.getOwnPropertyDescriptors(r))
          : d6(Object(r)).forEach(function (t) {
              Object.defineProperty(
                e,
                t,
                Object.getOwnPropertyDescriptor(r, t)
  ...
  var J3 = s.forwardRef(function (e, n) {
    var r = e.children,
      t = e.className,
      a = p(e, G3);
    return o.jsx(
      ...
      p6(
        p6({}, a),
        {},
        { ref: n, className: d('utrecht-badge-list', t), children: r }
      )
    );
  });
  J3.displayName = 'BadgeList';
  var z3 = ['children', 'className', 'attribution'];
  function C6(e, n) {
    var r = Object.keys(e);
    if (Object.getOwnPropertySymbols) {
      var t = Object.getOwnPropertySymbols(e);
  ...
  function b6(e) {
    for (var n = 1; n < arguments.length; n++) {
      var r = arguments[n] != null ? arguments[n] : {};
      n % 2
        ? C6(Object(r), !0).forEach(function (t) {
            b(e, t, r[t]);
          })
        : Object.getOwnPropertyDescriptors
          ? Object.defineProperties(e, Object.getOwnPropertyDescriptors(r))
          : C6(Object(r)).forEach(function (t) {
              Object.defineProperty(
                e,
                t,
                Object.getOwnPropertyDescriptor(r, t)
  ...
  var X3 = s.forwardRef(function (e, n) {
    var r = e.children,
      t = e.className,
      a = e.attribution,
      i = p(e, z3);
    return o.jsxs(
      ...
      b6(
        ...
        {
          ref: n,
          className: d('utrecht-blockquote', t),
          children: [
            r,
            a &&
              o.jsx('div', {
  ...
  function O6(e) {
    for (var n = 1; n < arguments.length; n++) {
      var r = arguments[n] != null ? arguments[n] : {};
      n % 2
        ? f6(Object(r), !0).forEach(function (t) {
            b(e, t, r[t]);
          })
        : Object.getOwnPropertyDescriptors
          ? Object.defineProperties(e, Object.getOwnPropertyDescriptors(r))
          : f6(Object(r)).forEach(function (t) {
              Object.defineProperty(
                e,
                t,
                Object.getOwnPropertyDescriptor(r, t)
  ...
  var z = s.forwardRef(function (e, n) {
    var r = e.boxContent,
      t = e.children,
      a = e.className,
      i = e.external,
        ...
        O6(
          {
            href: u ? void 0 : l,
            ref: n,
            role: f || (u ? 'link' : void 0),
            className: d(
              'utrecht-link',
              'utrecht-link--html-a',
              {
                'utrecht-link--box-content': r,
                'utrecht-link--external': i,
                'utrecht-link--placeholder': u,
              },
              a
            ),
  ...
  z.displayName = 'Link';
  var e7 = ['appearance', 'children', 'className', 'headingLevel', 'label'],
    r7 = ['className', 'children'],
  ...
  function $(e) {
    for (var n = 1; n < arguments.length; n++) {
      var r = arguments[n] != null ? arguments[n] : {};
      n % 2
        ? m6(Object(r), !0).forEach(function (t) {
            b(e, t, r[t]);
          })
        : Object.getOwnPropertyDescriptors
          ? Object.defineProperties(e, Object.getOwnPropertyDescriptors(r))
          : m6(Object(r)).forEach(function (t) {
              Object.defineProperty(
                e,
                t,
                Object.getOwnPropertyDescriptor(r, t)
              ...
              o.jsx(
                ...
                $(
                  $(
                    ...
                    y6({ type: 'https://schema.org/BreadcrumbList' })
                  ),
                  {},
                  { children: t }
                )
  ...
  a7.displayName = 'BreadcrumbNav';
  var h6 = s.forwardRef(function (e, n) {
    var r = e.className,
      t = e.children,
      a = p(e, r7);
    return o.jsx(
      ...
      $(
        $(
          $(
            { className: d('utrecht-breadcrumb-nav__item', r) },
            y6({ type: 'https://schema.org/ListItem', prop: 'itemListElement' })
          ),
          {},
          { ref: n },
          a
  ...
  h6.displayName = 'BreadcrumbNavItem';
  ...
  c7.displayName = 'BreadcrumbNavSeparator';
  var o7 = s.forwardRef(function (e, n) {
    var r = e.children,
      t = e.disabled,
      a = e.current,
      i = e.href,
          ...
          {},
          {
            ...
            children: [
              o.jsx(
                'span',
                $(
                  $({ className: 'utrecht-breadcrumb-nav__text' }, H1('name')),
                  {},
                  { children: r }
                )
              ),
              typeof l == 'number'
                ? o.jsx(
                    'meta',
                    $($({}, H1('position')), {}, { content: String(l + 1) })
                  )
                : null,
            ],
          }
  ...
  o7.displayName = 'BreadcrumbNavLink';
  var i7 = ['children', 'className', 'direction'];
  function j6(e, n) {
    var r = Object.keys(e);
    if (Object.getOwnPropertySymbols) {
      var t = Object.getOwnPropertySymbols(e);
  ...
  function g6(e) {
    for (var n = 1; n < arguments.length; n++) {
      var r = arguments[n] != null ? arguments[n] : {};
      n % 2
        ? j6(Object(r), !0).forEach(function (t) {
            b(e, t, r[t]);
          })
        : Object.getOwnPropertyDescriptors
          ? Object.defineProperties(e, Object.getOwnPropertyDescriptors(r))
          : j6(Object(r)).forEach(function (t) {
              Object.defineProperty(
                e,
                t,
                Object.getOwnPropertyDescriptor(r, t)
  ...
  function h1(e) {
    for (var n = 1; n < arguments.length; n++) {
      var r = arguments[n] != null ? arguments[n] : {};
      n % 2
        ? v6(Object(r), !0).forEach(function (t) {
            b(e, t, r[t]);
          })
        : Object.getOwnPropertyDescriptors
          ? Object.defineProperties(e, Object.getOwnPropertyDescriptors(r))
          : v6(Object(r)).forEach(function (t) {
              Object.defineProperty(
                e,
                t,
                Object.getOwnPropertyDescriptor(r, t)
  ...
  var d7 = function (n) {
    ...
    P6 = s.forwardRef(function (e, n) {
      var r = e.appearance,
        ...
        y = m;
      return (
        f === 'button' && (y = h1(h1({}, m), {}, { onKeyDown: d7 })),
        o.jsx(
          'a',
          h1(
            h1(
              {
                ...
                className: d(
                  ...
                  {
                    'utrecht-button-link--external': i,
                    ...
                    'utrecht-button-link--placeholder': u,
                  },
                  a
                ),
                rel: i ? 'external noopener noreferrer' : void 0,
  ...
  var C7 = s.forwardRef(function (e, n) {
    ...
    return (
      ...
      s.useEffect(
        function () {
          j.current && (j.current.indeterminate = l);
        },
        [l]
      ),
      o.jsx(
          ...
          {},
          {
            ...
            className: d(
              ...
              'utrecht-checkbox--html-input',
              {
                ...
                'utrecht-checkbox--invalid': u,
                'utrecht-checkbox--indeterminate': l,
                'utrecht-checkbox--required': f,
              },
              m
            ),
  ...
  C7.displayName = 'Checkbox';
  var b7 = ['children', 'className'];
  function x6(e, n) {
    var r = Object.keys(e);
    if (Object.getOwnPropertySymbols) {
      var t = Object.getOwnPropertySymbols(e);
  ...
  function L6(e) {
    for (var n = 1; n < arguments.length; n++) {
      var r = arguments[n] != null ? arguments[n] : {};
      n % 2
        ? x6(Object(r), !0).forEach(function (t) {
            b(e, t, r[t]);
          })
        : Object.getOwnPropertyDescriptors
          ? Object.defineProperties(e, Object.getOwnPropertyDescriptors(r))
          : x6(Object(r)).forEach(function (t) {
              Object.defineProperty(
                e,
                t,
                Object.getOwnPropertyDescriptor(r, t)
  ...
  var f7 = s.forwardRef(function (e, n) {
    var r = e.children,
      t = e.className,
      a = p(e, b7);
    return o.jsx(
      'code',
      L6(
        L6({ ref: n, className: d('utrecht-code', t) }, a),
        {},
        { children: r }
      )
    );
  ...
  var m7 = s.forwardRef(function (e, n) {
    var r = e.children,
      t = e.className,
      a = p(e, O7);
    return o.jsx(
      'pre',
      S6(
        S6({ ref: n, className: d('utrecht-code-block', t) }, a),
        {},
        {
          children: o.jsx('code', {
  ...
  m7.displayName = 'CodeBlock';
  var y7 = ['children', 'className', 'color', 'style'];
  function E6(e, n) {
    var r = Object.keys(e);
    if (Object.getOwnPropertySymbols) {
      var t = Object.getOwnPropertySymbols(e);
  ...
  var h7 = s.forwardRef(function (e, n) {
    var r = e.children,
      t = e.className,
      a = e.color,
      i = e.style,
    ...
    return o.jsx(
      ...
      j1(
        j1(
          {
            ref: n,
            className: d('utrecht-color-sample', t),
            style: j1(j1({}, i), {}, { color: a }),
            value: a,
          },
          l
        ),
  ...
  j7.displayName = 'ColumnLayout';
  var g7 = ['className'],
    v7 = ['className', 'position'];
  function $6(e, n) {
    var r = Object.keys(e);
    if (Object.getOwnPropertySymbols) {
      var t = Object.getOwnPropertySymbols(e);
  ...
  function g1(e) {
    for (var n = 1; n < arguments.length; n++) {
      var r = arguments[n] != null ? arguments[n] : {};
      n % 2
        ? $6(Object(r), !0).forEach(function (t) {
            b(e, t, r[t]);
          })
        : Object.getOwnPropertyDescriptors
          ? Object.defineProperties(e, Object.getOwnPropertyDescriptors(r))
          : $6(Object(r)).forEach(function (t) {
              Object.defineProperty(
                e,
                t,
                Object.getOwnPropertyDescriptor(r, t)
  ...
  var P7 = s.forwardRef(function (e, n) {
    var r = e.className,
      t = p(e, g7);
    return o.jsx(
      'div',
      g1(g1({ className: d('utrecht-combobox', r) }, t), {}, { ref: n })
    );
  });
  P7.displayName = 'Combobox';
  ...
  w7.displayName = 'ComboboxPopover';
  var N7 = ['children', 'currency', 'amount', 'locale', 'className'];
  function k6(e, n) {
    var r = Object.keys(e);
    if (Object.getOwnPropertySymbols) {
      var t = Object.getOwnPropertySymbols(e);
  ...
  function _6(e) {
    for (var n = 1; n < arguments.length; n++) {
      var r = arguments[n] != null ? arguments[n] : {};
      n % 2
        ? k6(Object(r), !0).forEach(function (t) {
            b(e, t, r[t]);
          })
        : Object.getOwnPropertyDescriptors
          ? Object.defineProperties(e, Object.getOwnPropertyDescriptors(r))
          : k6(Object(r)).forEach(function (t) {
              Object.defineProperty(
                e,
                t,
                Object.getOwnPropertyDescriptor(r, t)
  ...
  var x7 = function (n, r, t) {
    ...
    D7 = s.forwardRef(function (e, n) {
      var r = e.children,
        ...
        f = e.className,
        m = p(e, N7),
        y = typeof i == 'string' ? parseFloat(i) : i,
        j = x7(u, a, y),
        w = L7(u, a, y);
      return o.jsx(
        'data',
        _6(
          ...
          {},
          {
            ...
            className: d(
              ...
              y < 0 && 'utrecht-currency-data--negative',
              y > 0 && 'utrecht-currency-data--positive',
              f
            ),
            'aria-label': j,
            children: r || w,
  ...
  D7.displayName = 'CurrencyData';
  var S7 = ['children', 'className', 'dateTime', 'value'];
  function M6(e, n) {
    var r = Object.keys(e);
    if (Object.getOwnPropertySymbols) {
      var t = Object.getOwnPropertySymbols(e);
  ...
  var E7 = s.forwardRef(function (e, n) {
    var r = e.children,
      t = e.className,
      a = e.dateTime,
      i = e.value,
      l = p(e, S7),
      u = I({ children: r, className: d('utrecht-badge-data', t) }, l);
    return typeof a < 'u'
      ? o.jsx('time', I(I({}, u), {}, { dateTime: a, ref: n }))
      : typeof i < 'u'
        ? o.jsx('data', I(I({}, u), {}, { value: i, ref: n }))
        : o.jsx('span', I(I({}, u), {}, { ref: n }));
  });
  E7.displayName = 'DataBadge';
  var $7 = ['children', 'className'];
  function H6(e, n) {
    var r = Object.keys(e);
    if (Object.getOwnPropertySymbols) {
      var t = Object.getOwnPropertySymbols(e);
  ...
  var k7 = s.forwardRef(function (e, n) {
    var r = e.children,
      t = e.className,
      a = p(e, $7);
    return o.jsx(
      ...
      V6(
        V6({}, a),
        {},
        { ref: n, className: d('utrecht-document', t), children: r }
      )
    );
  });
  k7.displayName = 'Document';
  var _7 = ['appearance', 'children', 'className'],
    M7 = ['children', 'className'],
    H7 = ['children', 'className'],
    V7 = ['children', 'className'];
  function T6(e, n) {
    var r = Object.keys(e);
    if (Object.getOwnPropertySymbols) {
      var t = Object.getOwnPropertySymbols(e);
  ...
  var T7 = s.forwardRef(function (e, n) {
    var r = e.appearance,
      t = e.children,
      a = e.className,
      i = p(e, _7);
  ...
  T7.displayName = 'DataList';
  var R7 = s.forwardRef(function (e, n) {
    var r = e.children,
      t = e.className,
      a = p(e, M7);
    return o.jsx(
      ...
      K(
        K({}, a),
        {},
        { className: d('utrecht-data-list__item', t), ref: n, children: r }
      )
    );
  });
  R7.displayName = 'DataListItem';
  var K7 = s.forwardRef(function (e, n) {
    var r = e.children,
      t = e.className,
      a = p(e, H7);
    return o.jsx(
      ...
      K(
        K({}, a),
        {},
        { className: d('utrecht-data-list__item-key', t), ref: n, children: r }
      )
    );
  });
  K7.displayName = 'DataListKey';
  var Z7 = s.forwardRef(function (e, n) {
    var r = e.value,
      t = e.children,
      a = e.className,
    ...
    return o.jsx('dd', {
      className: d(
        ...
        a,
        l && 'utrecht-data-list__item-value--multiline'
      ),
      translate: typeof u == 'boolean' ? (u ? 'no' : 'yes') : void 0,
      ref: n,
      children: f ? o.jsx('span', { 'aria-label': i, children: '-' }) : t,
    });
  });
  Z7.displayName = 'DataListValue';
  var F7 = s.forwardRef(function (e, n) {
    var r = e.children,
      t = e.className,
      a = p(e, V7);
  ...
  F7.displayName = 'DataListActions';
  var I7 = ['align', 'children', 'className', 'modal'];
  function R6(e, n) {
    var r = Object.keys(e);
    if (Object.getOwnPropertySymbols) {
      var t = Object.getOwnPropertySymbols(e);
  ...
  var B7 = s.forwardRef(function (e, n) {
    var r = e.align,
      t = e.children,
      a = e.className,
      i = e.modal,
    ...
    return (
      ...
      s.useEffect(function () {
        i &&
          ...
          u !== void 0 &&
          u.current &&
          (u.current.close(), u.current.showModal());
      }),
      o.jsx(
        'dialog',
        K6(
    ...
    return o.jsx(
      ...
      F6(
        F6(
          {
            ref: n,
            className: d('utrecht-emphasis', 'utrecht-emphasis--stressed', t),
          },
          a
        ),
        {},
  ...
  var W7 = [
    ...
    U7 = ['className', 'children', 'disabled', 'invalid'];
  function I6(e, n) {
    var r = Object.keys(e);
    if (Object.getOwnPropertySymbols) {
      var t = Object.getOwnPropertySymbols(e);
  ...
  var Y7 = s.forwardRef(function (e, n) {
      ...
      v1(
        ...
        {},
        {
          ...
          className: d(
            ...
            m && 'utrecht-form-fieldset--invalid',
            i
          ),
          children: o.jsx('fieldset', {
            'aria-describedby': r,
            'aria-label': t,
            'aria-labelledby': a,
  ...
  Y7.displayName = 'Fieldset';
  var G7 = s.forwardRef(function (e, n) {
    var r = e.className,
      t = e.children,
      a = e.disabled,
      i = e.invalid,
      ...
      v1(
        ...
        {},
        {
          ...
          className: d(
            ...
            i && 'utrecht-form-fieldset--invalid',
            r
          ),
          children: t,
        }
  ...
  G7.displayName = 'Fieldset';
  var J7 = ['className', 'children'];
  function B6(e, n) {
    var r = Object.keys(e);
    if (Object.getOwnPropertySymbols) {
      var t = Object.getOwnPropertySymbols(e);
  ...
  var Q7 = s.forwardRef(function (e, n) {
    ...
    return o.jsx(
      ...
      W6(
        W6({}, a),
        {},
        { ref: n, className: d('utrecht-figure', r), children: t }
      )
    );
  });
  Q7.displayName = 'Figure';
  var e4 = ['className', 'children'];
  function U6(e, n) {
    var r = Object.keys(e);
    if (Object.getOwnPropertySymbols) {
      var t = Object.getOwnPropertySymbols(e);
  ...
  var r4 = s.forwardRef(function (e, n) {
    var r = e.className,
      t = e.children,
      a = p(e, e4);
    return o.jsx(
      ...
      Y6(
        Y6({}, a),
        {},
        { ref: n, className: d('utrecht-figure__caption', r), children: t }
      )
    );
  });
  r4.displayName = 'FigureCaption';
  var t4 = [
    'className',
    'children',
    'description',
  ...
  var z6 = s.forwardRef(function (e, n) {
    var r = e.className,
      t = e.children,
      a = e.description,
      i = e.input,
      ...
      J6(
        ...
        {},
        {
          ...
          className: d(
            'utrecht-form-field',
            {
              'utrecht-form-field--invalid': l,
              'utrecht-form-field--checkbox': f === 'checkbox',
              'utrecht-form-field--radio': f === 'radio',
              'utrecht-form-field--text': !f || f === 'text',
            },
            r
          ),
          children: [
  ...
  z6.displayName = 'FormField';
  var n4 = ['invalid', 'valid', 'warning', 'className', 'children'];
  function X6(e, n) {
    var r = Object.keys(e);
    if (Object.getOwnPropertySymbols) {
      var t = Object.getOwnPropertySymbols(e);
  ...
  ee.displayName = 'FormFieldDescription';
  var a4 = ['className', 'children'];
  function re(e, n) {
    var r = Object.keys(e);
    if (Object.getOwnPropertySymbols) {
      var t = Object.getOwnPropertySymbols(e);
  ...
  var ne = s.forwardRef(function (e, n) {
    var r = e.className,
      t = e.children,
      a = p(e, a4);
    return o.jsx(
      ...
      te(
        ...
        {
          ref: n,
          className: d('utrecht-form-field-error-message', r),
          children: t,
        }
      )
    );
  });
  ne.displayName = 'FormFieldErrorMessage';
  var c4 = ['children', 'className', 'type', 'disabled', 'checked'];
  function ae(e, n) {
    var r = Object.keys(e);
    if (Object.getOwnPropertySymbols) {
      var t = Object.getOwnPropertySymbols(e);
  ...
  var oe = s.forwardRef(function (e, n) {
    var r = e.children,
      t = e.className,
      a = e.type,
      i = e.disabled,
      ...
      ce(
        ...
        {},
        {
          ...
          className: d(
            ...
            i && 'utrecht-form-label--disabled',
            l && 'utrecht-form-label--checked',
            t
          ),
          children: r,
        }
  ...
  var le = s.forwardRef(function (e, n) {
    var r = e.dir,
      t = e.disabled,
      a = e.invalid,
      i = e.readOnly,
      ...
      se(
        ...
        {},
        {
          ...
          className: d(
            ...
            i && 'utrecht-textbox--readonly',
            (l || u) && 'utrecht-textbox--required',
            f
          ),
          dir: r ?? 'auto',
          disabled: t,
          ...
          inputMode: j || (y === 'number' ? 'numeric' : void 0),
        }
      )
    );
  });
  le.displayName = 'Textbox';
  var i4 = [
    'name',
    'invalid',
    'disabled',
  ...
  var s4 = s.forwardRef(function (e, n) {
    var r = e.name,
      t = e.invalid,
      a = e.disabled,
      i = e.label,
    ...
    return o.jsxs(
      z6,
      de(
        de({ invalid: t, ref: n }, L1),
        {},
        {
          children: [
            o.jsx('div', {
              className: 'utrecht-form-field__label',
              children: o.jsx(oe, { htmlFor: p1, children: i }),
            }),
            u &&
              o.jsx(ee, {
                className: 'utrecht-form-field__description',
  ...
  s4.displayName = 'FormFieldTextbox';
  var l4 = [
    'checked',
    'disabled',
    'invalid',
  ...
  var d4 = s.forwardRef(function (e, n) {
    var r = e.checked,
      t = e.disabled,
      a = e.invalid,
      i = e.id,
    ...
    return o.jsxs('div', {
      className: d(
        ...
        'utrecht-form-toggle--html-checkbox',
        {
          ...
          'utrecht-form-toggle--required': u,
        },
        y
      ),
      hidden: l,
      children: [
        ...
        o.jsx('label', {
          ...
          children: o.jsx('div', { className: 'utrecht-form-toggle__thumb' }),
        }),
      ],
    });
  });
  d4.displayName = 'FormToggle';
  var p4 = ['children', 'className'];
  function Ce(e, n) {
    var r = Object.keys(e);
    if (Object.getOwnPropertySymbols) {
      var t = Object.getOwnPropertySymbols(e);
  ...
  var C4 = s.forwardRef(function (e, n) {
    var r = e.children,
      t = e.className,
      a = p(e, p4);
    return o.jsx(
      ...
      be(
        be({}, a),
        {},
        { ref: n, className: d('utrecht-html', t), children: r }
      )
    );
  });
  C4.displayName = 'HTMLContent';
  ...
  var f4 = s.forwardRef(function (e, n) {
    var r = e.children,
      t = e.className,
      a = p(e, b4);
    return o.jsx(
      ...
      Oe(
        Oe({}, a),
        {},
        { ref: n, className: d('utrecht-heading-1', t), children: r }
      )
    );
  });
  f4.displayName = 'Heading1';
  ...
  var m4 = s.forwardRef(function (e, n) {
    var r = e.children,
      t = e.className,
      a = p(e, O4);
    return o.jsx(
      ...
      ye(
        ye({}, a),
        {},
        { ref: n, className: d('utrecht-heading-2', t), children: r }
      )
    );
  });
  m4.displayName = 'Heading2';
  var y4 = ['children', 'className'];
  function he(e, n) {
    var r = Object.keys(e);
    if (Object.getOwnPropertySymbols) {
      var t = Object.getOwnPropertySymbols(e);
  ...
  var h4 = s.forwardRef(function (e, n) {
    var r = e.children,
      t = e.className,
      a = p(e, y4);
    return o.jsx(
      ...
      je(
        je({}, a),
        {},
        { ref: n, className: d('utrecht-heading-3', t), children: r }
      )
    );
  });
  h4.displayName = 'Heading3';
  var j4 = ['children', 'className'];
  function ge(e, n) {
    var r = Object.keys(e);
    if (Object.getOwnPropertySymbols) {
      var t = Object.getOwnPropertySymbols(e);
  ...
  var g4 = s.forwardRef(function (e, n) {
    var r = e.children,
      t = e.className,
      a = p(e, j4);
    return o.jsx(
      ...
      ve(
        ve({}, a),
        {},
        { ref: n, className: d('utrecht-heading-4', t), children: r }
      )
    );
  });
  g4.displayName = 'Heading4';
  var v4 = ['children', 'className'];
  function Pe(e, n) {
    var r = Object.keys(e);
    if (Object.getOwnPropertySymbols) {
      var t = Object.getOwnPropertySymbols(e);
  ...
  var P4 = s.forwardRef(function (e, n) {
    var r = e.children,
      t = e.className,
      a = p(e, v4);
    return o.jsx(
      ...
      we(
        we({}, a),
        {},
        { ref: n, className: d('utrecht-heading-5', t), children: r }
      )
    );
  });
  P4.displayName = 'Heading5';
  var w4 = ['children', 'className'];
  function Ne(e, n) {
    var r = Object.keys(e);
    if (Object.getOwnPropertySymbols) {
      var t = Object.getOwnPropertySymbols(e);
  ...
  var N4 = s.forwardRef(function (e, n) {
    ...
    return o.jsx(
      ...
      xe(
        xe({}, a),
        {},
        { ref: n, className: d('utrecht-heading-6', t), children: r }
      )
    );
  });
  N4.displayName = 'Heading6';
  var x4 = ['children', 'className'];
  function Le(e, n) {
    var r = Object.keys(e);
    if (Object.getOwnPropertySymbols) {
      var t = Object.getOwnPropertySymbols(e);
  ...
  var L4 = s.forwardRef(function (e, n) {
    var r = e.children,
      t = e.className,
      a = p(e, x4);
    return o.jsx(
      ...
      De(
        De({}, a),
        {},
        { ref: n, className: d('utrecht-heading-group', t), children: r }
      )
    );
  });
  L4.displayName = 'HeadingGroup';
  var D4 = ['children', 'value', 'className'];
  function Se(e, n) {
    var r = Object.keys(e);
    if (Object.getOwnPropertySymbols) {
      var t = Object.getOwnPropertySymbols(e);
      ...
      return o.jsx(
        ...
        Ee(
          ...
          {},
          {
            ref: n,
            value: l,
            className: d('utrecht-iban-data', a),
            translate: 'no',
            children: r || u,
          }
        )
  ...
  $4.displayName = 'IBANData';
  var k4 = ['children', 'className'];
  function $e(e, n) {
    var r = Object.keys(e);
    if (Object.getOwnPropertySymbols) {
      var t = Object.getOwnPropertySymbols(e);
  ...
  var _4 = s.forwardRef(function (e, n) {
    var r = e.children,
      t = e.className,
      a = p(e, k4);
    return o.jsx(
      ...
      ke(
        ke(
          { 'aria-hidden': 'true', ref: n, className: d('utrecht-icon', t) },
          a
        ),
        {},
        { children: r }
  ...
  _4.displayName = 'Icon';
  var M4 = ['component', 'currentChar', 'characters', 'onLinkClick', 'Link'];
  function _e(e, n) {
    var r = Object.keys(e);
    if (Object.getOwnPropertySymbols) {
      var t = Object.getOwnPropertySymbols(e);
        ...
        ? (m = a.map(function (y) {
            ...
            return s.createElement(
              ...
              P1(
                ...
                {},
                {
                  className: d({ 'utrecht-index-char-nav__link--current': S }),
                  ref: n,
                  key: j,
                  appearance: S
        ...
        : (m = a.map(function (y) {
            var j = y.char,
              ...
              Z = d(
                ...
                {
                  'utrecht-index-char-nav__link--current': E,
                  'utrecht-button-link--primary-action': E,
                  'utrecht-button-link--secondary-action': !E,
                  'utrecht-index-char-nav__link--disabled': w,
                  'utrecht-button-link--placeholder': w,
                }
              );
            return o.jsx(
              f,
                ...
                P1(
                  {
                    ...
                    appearance: l
                      ...
                      : E
                        ...
                        : 'secondary-action-button',
                    href: S,
                    className: d(l && Z, 'utrecht-index-char-nav__link', {
                      'utrecht-index-char-nav__link--disabled': w,
                      'utrecht-index-char-nav__link--current': E,
                    }),
                    'aria-current': E ? 'page' : void 0,
                    'aria-disabled': w,
                    placeholder: l ? void 0 : w,
                    onClick: function () {
                      return typeof i == 'function' && i(j);
                    },
                  },
  ...
  H4.displayName = 'IndexCharNav';
  var V4 = ['className', 'photo'];
  function Me(e, n) {
    var r = Object.keys(e);
    if (Object.getOwnPropertySymbols) {
      var t = Object.getOwnPropertySymbols(e);
  ...
  var T4 = s.forwardRef(function (e, n) {
    var r = e.className,
      t = e.photo,
      a = p(e, V4);
    return o.jsx(
      ...
      He(
        He({}, a),
        {},
        { ref: n, className: d('utrecht-img', { 'utrecht-img--photo': t }, r) }
      )
    );
  });
  T4.displayName = 'Image';
  var R4 = ['children', 'disabled', 'inline', 'className', 'pressed', 'type'];
  function Ve(e, n) {
    var r = Object.keys(e);
    if (Object.getOwnPropertySymbols) {
      var t = Object.getOwnPropertySymbols(e);
  ...
  var K4 = s.forwardRef(function (e, n) {
    var r = e.children,
      t = e.disabled,
      a = e.inline,
      i = e.className,
    ...
    return o.jsx(
      ...
      Te(
        Te(
          {
            ref: n,
            'aria-pressed': typeof l == 'boolean' ? l : void 0,
            className: d(
              'utrecht-link-button',
  ...
  K4.displayName = 'LinkButton';
  var Z4 = ['children', 'className', 'external'];
  function Re(e, n) {
    var r = Object.keys(e);
    if (Object.getOwnPropertySymbols) {
      var t = Object.getOwnPropertySymbols(e);
  ...
  var F4 = s.forwardRef(function (e, n) {
    ...
    return o.jsx(
      ...
      Ke(
        ...
        {
          ref: n,
          className: d('utrecht-link-social', t),
  ...
  F4.displayName = 'LinkSocial';
  var I4 = ['className', 'icon', 'children'],
    B4 = ['children', 'icon', 'links', 'className'];
  function Ze(e, n) {
    var r = Object.keys(e);
    if (Object.getOwnPropertySymbols) {
      var t = Object.getOwnPropertySymbols(e);
  ...
  var Fe = s.forwardRef(function (e, n) {
    var r = e.className,
      t = e.icon,
      a = e.children,
      i = p(e, I4);
    return o.jsx('li', {
      className: d('utrecht-link-list__item', r),
      children: o.jsxs(
        z,
        d1(
          d1({ className: 'utrecht-link-list__link' }, i),
          {},
          {
            ref: n,
            children: [
  ...
  Fe.displayName = 'LinkListLink';
  var A4 = s.forwardRef(function (e, n) {
    var r = e.children,
      t = e.icon,
      a = e.links,
      i = e.className,
        ...
        d1(
          {
            role: 'list',
            ref: n,
            className: d('utrecht-link-list', 'utrecht-link-list--html-ul', i),
          },
          l
        ),
        {},
          ...
          children: [
            ...
            Array.isArray(a) &&
              a.map(function (u, f) {
                return o.jsx(
                  Fe,
                  d1({ icon: typeof t == 'function' ? t() : void 0 }, u),
                  f
                );
              }),
          ],
  ...
  var q4 = [
    ...
    W4 = ['children', 'label'],
    U4 = ['active', 'className', 'disabled', 'selected'];
  function Ie(e, n) {
    var r = Object.keys(e);
    if (Object.getOwnPropertySymbols) {
      var t = Object.getOwnPropertySymbols(e);
  ...
  var Y4 = s.forwardRef(function (e, n) {
    var r = e.children,
      t = e.className,
      a = e.disabled,
      i = e.invalid,
        ...
        X(
          {
            className: d(
              ...
              'utrecht-listbox--html-div',
              {
                ...
                'utrecht-listbox--invalid': i,
                'utrecht-listbox--read-only': u,
              },
              t
            ),
            role: 'listbox',
  ...
  G4.displayName = 'ListboxOptionGroup';
  var J4 = s.forwardRef(function (e, n) {
    var r = e.active,
      t = e.className,
      a = e.disabled,
      i = e.selected,
  ...
  J4.displayName = 'ListboxOption';
  var z4 = ['children', 'className'];
  function Be(e, n) {
    var r = Object.keys(e);
    if (Object.getOwnPropertySymbols) {
      var t = Object.getOwnPropertySymbols(e);
  ...
  var X4 = s.forwardRef(function (e, n) {
    var r = e.children,
      t = e.className,
      a = p(e, z4);
    return o.jsx(
      'div',
      Ae(
        Ae({ ref: n, className: d('utrecht-logo', t) }, a),
        {},
        { children: r }
      )
    );
  ...
  var Q4 = s.forwardRef(function (e, n) {
    var r = _1({}, ($3(e), e));
    return o.jsxs(
      'svg',
      We(
  ...
  Q4.displayName = 'LogoImage';
  var e9 = ['children', 'className'];
  function Ue(e, n) {
    var r = Object.keys(e);
    if (Object.getOwnPropertySymbols) {
      var t = Object.getOwnPropertySymbols(e);
  ...
  var r9 = s.forwardRef(function (e, n) {
    var r = e.children,
      t = e.className,
      a = p(e, e9);
    return o.jsx(
      'mark',
      Ye(
        Ye({ ref: n, className: d('utrecht-mark', t) }, a),
        {},
        { children: r }
      )
    );
  ...
  var n9 = s.forwardRef(function (e, n) {
    var r = e.children,
      t = e.className,
      a = p(e, t9);
    return o.jsx(
  ...
  n9.displayName = 'MultilineData';
  var a9 = ['children', 'className', 'value'];
  function ze(e, n) {
    var r = Object.keys(e);
    if (Object.getOwnPropertySymbols) {
      var t = Object.getOwnPropertySymbols(e);
  ...
  var c9 = s.forwardRef(function (e, n) {
    var r = e.children,
      t = e.className,
      a = e.value,
      i = p(e, a9);
    return o.jsx(
      ...
      Xe(
        ...
        {},
        { ref: n, className: d('utrecht-number-data', t), children: r }
      )
    );
  });
  c9.displayName = 'NumberData';
  var o9 = ['children', 'className'];
  function Qe(e, n) {
    var r = Object.keys(e);
    if (Object.getOwnPropertySymbols) {
      var t = Object.getOwnPropertySymbols(e);
  ...
  var i9 = s.forwardRef(function (e, n) {
    var r = e.children,
      t = e.className,
      a = p(e, o9);
    return o.jsx(
      ...
      e5(
        e5({}, a),
        {},
        { ref: n, className: d('utrecht-ordered-list', t), children: r }
      )
    );
  });
  i9.displayName = 'OrderedList';
  var s9 = ['children', 'className'];
  function r5(e, n) {
    var r = Object.keys(e);
    if (Object.getOwnPropertySymbols) {
      var t = Object.getOwnPropertySymbols(e);
  ...
  var l9 = s.forwardRef(function (e, n) {
    var r = e.children,
      t = e.className,
      a = p(e, s9);
    return o.jsx(
      ...
      t5(
        t5({}, a),
        {},
        { ref: n, className: d('utrecht-ordered-list__item', t), children: r }
      )
    );
  });
  l9.displayName = 'OrderedListItem';
  var u9 = ['children', 'className'];
  function n5(e, n) {
    var r = Object.keys(e);
    if (Object.getOwnPropertySymbols) {
      var t = Object.getOwnPropertySymbols(e);
  ...
  var d9 = s.forwardRef(function (e, n) {
    var r = e.children,
      t = e.className,
      a = p(e, u9);
    return o.jsx(
      ...
      a5(
        a5({}, a),
        {},
        { ref: n, className: d('utrecht-page', t), children: r }
      )
    );
  });
  d9.displayName = 'Page';
  var p9 = ['children', 'className'],
    C9 = ['children', 'className'];
  function c5(e, n) {
    var r = Object.keys(e);
    if (Object.getOwnPropertySymbols) {
      var t = Object.getOwnPropertySymbols(e);
  ...
  var b9 = s.forwardRef(function (e, n) {
    var r = e.children,
      t = e.className,
      a = p(e, p9);
    return o.jsx(
      ...
      w1(
        w1({}, a),
        {},
        { ref: n, className: d('utrecht-page-content', t), children: r }
      )
    );
  });
  b9.displayName = 'PageContent';
  var f9 = s.forwardRef(function (e, n) {
    var r = e.children,
      t = e.className,
      a = p(e, C9);
    return o.jsx(
      ...
      w1(
        w1({}, a),
        {},
        { ref: n, className: d('utrecht-page-content__main', t), children: r }
      )
    );
  });
  f9.displayName = 'PageContentMain';
  var O9 = ['children', 'className'];
  function o5(e, n) {
    var r = Object.keys(e);
    if (Object.getOwnPropertySymbols) {
  ...
  function i5(e) {
    for (var n = 1; n < arguments.length; n++) {
      var r = arguments[n] != null ? arguments[n] : {};
      n % 2
        ? o5(Object(r), !0).forEach(function (t) {
            b(e, t, r[t]);
          })
        : Object.getOwnPropertyDescriptors
          ? Object.defineProperties(e, Object.getOwnPropertyDescriptors(r))
          : o5(Object(r)).forEach(function (t) {
              Object.defineProperty(
                e,
                t,
                Object.getOwnPropertyDescriptor(r, t)
  ...
  var m9 = s.forwardRef(function (e, n) {
    var r = e.children,
      t = e.className,
      a = p(e, O9);
    return o.jsx(
      ...
      i5(
        i5({}, a),
        {},
        { ref: n, className: d('utrecht-page-footer', t), children: r }
      )
    );
  });
  m9.displayName = 'PageFooter';
  var y9 = ['children', 'className'];
  function s5(e, n) {
    var r = Object.keys(e);
    if (Object.getOwnPropertySymbols) {
      var t = Object.getOwnPropertySymbols(e);
  ...
  var h9 = s.forwardRef(function (e, n) {
    var r = e.children,
      t = e.className,
      a = p(e, y9);
    return o.jsx(
      ...
      l5(
        l5({}, a),
        {},
        { ref: n, className: d('utrecht-page-header', t), children: r }
      )
    );
  });
  h9.displayName = 'PageHeader';
  var j9 = ['children', 'className', 'lead', 'small'];
  function u5(e, n) {
    var r = Object.keys(e);
    if (Object.getOwnPropertySymbols) {
      var t = Object.getOwnPropertySymbols(e);
  ...
  var g9 = s.forwardRef(function (e, n) {
    var r = e.children,
      t = e.className,
      a = e.lead,
      i = e.small,
      ...
      d5(
        ...
        {},
        {
          ...
          className: d(
            ...
            i && 'utrecht-paragraph--small',
            t
          ),
          children: a
            ? o.jsx('b', { className: 'utrecht-paragraph__b', children: r })
            : i
              ? o.jsx('small', {
  ...
  g9.displayName = 'Paragraph';
  var v9 = ['loading', 'className'];
  function p5(e, n) {
    var r = Object.keys(e);
    if (Object.getOwnPropertySymbols) {
      var t = Object.getOwnPropertySymbols(e);
  ...
  var w9 = s.forwardRef(function (e, n) {
    var r = e.loading,
      t = e.className,
      a = p(e, v9);
    return o.jsx(
  ...
  w9.displayName = 'DataPlaceholder';
  var N9 = ['children', 'className'];
  function C5(e, n) {
    var r = Object.keys(e);
    if (Object.getOwnPropertySymbols) {
      var t = Object.getOwnPropertySymbols(e);
  ...
  var x9 = s.forwardRef(function (e, n) {
    var r = e.children,
      t = e.className,
      a = p(e, N9);
    return o.jsx(
      ...
      b5(
        b5({}, a),
        {},
        { ref: n, className: d('utrecht-pre-heading', t), children: r }
      )
    );
  });
  x9.displayName = 'PreHeading';
  var L9 = ['children', 'className', 'dateTime', 'value'];
  function f5(e, n) {
    var r = Object.keys(e);
    if (Object.getOwnPropertySymbols) {
      var t = Object.getOwnPropertySymbols(e);
  ...
  function B(e) {
    for (var n = 1; n < arguments.length; n++) {
      var r = arguments[n] != null ? arguments[n] : {};
      n % 2
        ? f5(Object(r), !0).forEach(function (t) {
            b(e, t, r[t]);
          })
        : Object.getOwnPropertyDescriptors
          ? Object.defineProperties(e, Object.getOwnPropertyDescriptors(r))
          : f5(Object(r)).forEach(function (t) {
              Object.defineProperty(
                e,
                t,
                Object.getOwnPropertyDescriptor(r, t)
  ...
  var D9 = s.forwardRef(function (e, n) {
    var r = e.children,
      ...
      u = B(
        {
          children: o.jsx('bdi', { translate: 'no', children: r }),
          className: d('utrecht-preserve-data', t),
        },
        l
      );
    return typeof a < 'u'
      ? o.jsx('time', B(B({}, u), {}, { dateTime: a, ref: n }))
      : typeof i < 'u'
        ? o.jsx('data', B(B({}, u), {}, { value: i, ref: n }))
        : o.jsx(
            'bdi',
            B(B({ translate: 'no', ref: n }, u), {}, { children: r })
          );
  });
  D9.displayName = 'PreserveData';
  var S9 = ['disabled', 'required', 'className', 'invalid'];
  function O5(e, n) {
    var r = Object.keys(e);
    if (Object.getOwnPropertySymbols) {
      var t = Object.getOwnPropertySymbols(e);
  ...
  var $9 = s.forwardRef(function (e, n) {
    var r = e.disabled,
      t = e.required,
      a = e.className,
      i = e.invalid,
      ...
      E9(
        {
          ...
          className: d(
            ...
            i && 'utrecht-radio-button--invalid',
            a
          ),
        },
        l
  ...
  $9.displayName = 'RadioButton';
  var k9 = ['className', 'children'];
  function m5(e, n) {
    var r = Object.keys(e);
    if (Object.getOwnPropertySymbols) {
      var t = Object.getOwnPropertySymbols(e);
  ...
  var _9 = s.forwardRef(function (e, n) {
    var r = e.className,
      t = e.children,
      a = p(e, k9);
    return o.jsx(
      ...
      y5(
        y5({}, a),
        {},
        { ref: n, className: d('utrecht-rich-text', r), children: t }
      )
    );
  });
  _9.displayName = 'RichText';
  var M9 = ['busy', 'invalid', 'required', 'className', 'noscript', 'children'],
    H9 = ['disabled', 'invalid', 'value', 'children', 'className'];
  function h5(e, n) {
    var r = Object.keys(e);
    if (Object.getOwnPropertySymbols) {
      var t = Object.getOwnPropertySymbols(e);
  ...
  function N1(e) {
    for (var n = 1; n < arguments.length; n++) {
      var r = arguments[n] != null ? arguments[n] : {};
      n % 2
        ? h5(Object(r), !0).forEach(function (t) {
            b(e, t, r[t]);
          })
        : Object.getOwnPropertyDescriptors
          ? Object.defineProperties(e, Object.getOwnPropertyDescriptors(r))
          : h5(Object(r)).forEach(function (t) {
              Object.defineProperty(
                e,
                t,
                Object.getOwnPropertyDescriptor(r, t)
  ...
  var V9 = s.forwardRef(function (e, n) {
    var r = e.busy,
      t = e.invalid,
      a = e.required,
      i = e.className,
        ...
        N1(
          {
            ...
            required: l ? a : !1,
            'aria-required': l ? void 0 : a || void 0,
            className: d(
              'utrecht-select',
  ...
  V9.displayName = 'Select';
  var T9 = s.forwardRef(function (e, n) {
    var r = e.disabled,
      t = e.invalid,
      a = e.value,
      i = e.children,
  ...
  T9.displayName = 'SelectOption';
  var R9 = ['className', 'children'];
  function j5(e, n) {
    var r = Object.keys(e);
    if (Object.getOwnPropertySymbols) {
      var t = Object.getOwnPropertySymbols(e);
  ...
  function g5(e) {
    for (var n = 1; n < arguments.length; n++) {
      var r = arguments[n] != null ? arguments[n] : {};
      n % 2
        ? j5(Object(r), !0).forEach(function (t) {
            b(e, t, r[t]);
          })
        : Object.getOwnPropertyDescriptors
          ? Object.defineProperties(e, Object.getOwnPropertyDescriptors(r))
          : j5(Object(r)).forEach(function (t) {
              Object.defineProperty(
                e,
                t,
                Object.getOwnPropertyDescriptor(r, t)
  ...
  var K9 = s.forwardRef(function (e, n) {
    var r = e.className;
    e.children;
    var t = p(e, R9);
    return o.jsx(
      'hr',
      g5(g5({}, t), {}, { ref: n, className: d('utrecht-separator', r) })
    );
  });
  K9.displayName = 'Separator';
  var Z9 = ['children', 'className'];
  function v5(e, n) {
    var r = Object.keys(e);
    if (Object.getOwnPropertySymbols) {
      var t = Object.getOwnPropertySymbols(e);
  ...
  F9.displayName = 'SkipLink';
  var I9 = ['aside', 'children', 'className', 'type'];
  function w5(e, n) {
    var r = Object.keys(e);
    if (Object.getOwnPropertySymbols) {
      var t = Object.getOwnPropertySymbols(e);
  ...
  function Q(e) {
    for (var n = 1; n < arguments.length; n++) {
      var r = arguments[n] != null ? arguments[n] : {};
      n % 2
        ? w5(Object(r), !0).forEach(function (t) {
            b(e, t, r[t]);
          })
        : Object.getOwnPropertyDescriptors
          ? Object.defineProperties(e, Object.getOwnPropertyDescriptors(r))
          : w5(Object(r)).forEach(function (t) {
              Object.defineProperty(
                e,
                t,
                Object.getOwnPropertyDescriptor(r, t)
  ...
  var B9 = s.forwardRef(function (e, n) {
      ...
      u = Q(
        ...
        {},
        {
          ...
          className: d(
            ...
            {
              'utrecht-spotlight-section--info': i === 'info',
    ...
    return r
      ? o.jsx('aside', Q(Q({}, u), {}, { children: t }))
      : o.jsx('section', Q(Q({}, u), {}, { children: t }));
  });
  B9.displayName = 'SpotlightSection';
  var A9 = ['className', 'status'];
  function N5(e, n) {
    var r = Object.keys(e);
    if (Object.getOwnPropertySymbols) {
      var t = Object.getOwnPropertySymbols(e);
  ...
  var q9 = s.forwardRef(function (e, n) {
    var r = e.className,
      t = e.status,
      a = p(e, A9);
    return o.jsx(
  ...
  q9.displayName = 'StatusBadge';
  var W9 = ['children', 'className'];
  function L5(e, n) {
    var r = Object.keys(e);
    if (Object.getOwnPropertySymbols) {
      var t = Object.getOwnPropertySymbols(e);
  ...
  var U9 = s.forwardRef(function (e, n) {
    var r = e.children,
      t = e.className,
      a = p(e, W9);
    return o.jsx(
      ...
      D5(
        D5(
          {
            ref: n,
            className: d('utrecht-emphasis', 'utrecht-emphasis--strong', t),
          },
          a
        ),
        {},
  ...
  var G9 = s.forwardRef(function (e, n) {
    ...
    return o.jsx(
      ...
      E5(
        E5({}, a),
        {},
        { ref: n, className: d('utrecht-surface', t), children: r }
      )
    );
  });
  G9.displayName = 'Surface';
  var J9 = ['overflowInline', 'children', 'className'];
  function $5(e, n) {
    var r = Object.keys(e);
    if (Object.getOwnPropertySymbols) {
      var t = Object.getOwnPropertySymbols(e);
  ...
  var z9 = s.forwardRef(function (e, n) {
  ...
  z9.displayName = 'TableContainer';
  var X9 = ['busy', 'children', 'className'];
  function _5(e, n) {
    var r = Object.keys(e);
    if (Object.getOwnPropertySymbols) {
      var t = Object.getOwnPropertySymbols(e);
  ...
  var Q9 = s.forwardRef(function (e, n) {
    ...
    return o.jsx(
      ...
      M5(
        ...
        {
          ref: n,
          className: d('utrecht-table', { 'utrecht-table--busy': r }, a),
          children: t,
        }
      )
    );
  });
  Q9.displayName = 'Table';
  var e8 = ['children', 'className'];
  function H5(e, n) {
    var r = Object.keys(e);
    if (Object.getOwnPropertySymbols) {
      var t = Object.getOwnPropertySymbols(e);
  ...
  var r8 = s.forwardRef(function (e, n) {
    ...
    return o.jsx(
      ...
      V5(
        V5({}, a),
        {},
        { ref: n, className: d('utrecht-table__body', t), children: r }
      )
    );
  });
  r8.displayName = 'TableBody';
  var t8 = ['children', 'className'];
  function T5(e, n) {
    var r = Object.keys(e);
    if (Object.getOwnPropertySymbols) {
      var t = Object.getOwnPropertySymbols(e);
  ...
  var n8 = s.forwardRef(function (e, n) {
    var r = e.children,
      t = e.className,
      a = p(e, t8);
    return o.jsx(
      ...
      R5(
        R5({}, a),
        {},
        { ref: n, className: d('utrecht-table__caption', t), children: r }
      )
    );
  });
  n8.displayName = 'TableCaption';
  var a8 = ['children', 'className', 'numericColumn', 'selected'];
  function K5(e, n) {
    var r = Object.keys(e);
    if (Object.getOwnPropertySymbols) {
      var t = Object.getOwnPropertySymbols(e);
  ...
  var c8 = s.forwardRef(function (e, n) {
    var r = e.children,
      t = e.className,
      a = e.numericColumn,
      i = e.selected,
      ...
      Z5(
        ...
        {},
        {
          ...
          className: d(
            'utrecht-table__cell',
            {
              'utrecht-table__cell--selected': i,
  ...
  c8.displayName = 'TableCell';
  var o8 = ['children', 'className', 'sticky'];
  function F5(e, n) {
    var r = Object.keys(e);
    if (Object.getOwnPropertySymbols) {
      var t = Object.getOwnPropertySymbols(e);
  ...
  var i8 = s.forwardRef(function (e, n) {
    var r = e.children,
      t = e.className,
      a = e.sticky,
      i = p(e, o8);
  ...
  i8.displayName = 'TableFooter';
  var s8 = ['children', 'className', 'sticky'];
  function B5(e, n) {
    var r = Object.keys(e);
    if (Object.getOwnPropertySymbols) {
      var t = Object.getOwnPropertySymbols(e);
  ...
  var d8 = s.forwardRef(function (e, n) {
    var r = e.children,
      t = e.className,
      a = e.numericColumn,
      i = e.selected,
    ...
    return o.jsx(
      'th',
      W5(
        W5({ 'aria-selected': i ? !0 : void 0, scope: u }, f),
        {},
        {
          ref: n,
          className: d(
            'utrecht-table__header-cell',
            {
              ...
              'utrecht-table__header-cell--selected': i,
              'utrecht-table__header-cell--sticky-inline': l && u === 'row',
              'utrecht-table__header-cell--sticky-block': l && u === 'col',
            },
            t
          ),
          children: r,
  ...
  d8.displayName = 'TableHeaderCell';
  var p8 = ['children', 'className', 'selected'];
  function U5(e, n) {
    var r = Object.keys(e);
    if (Object.getOwnPropertySymbols) {
      var t = Object.getOwnPropertySymbols(e);
  ...
  C8.displayName = 'TableRow';
  var b8 = ['dir', 'disabled', 'invalid', 'readOnly', 'required', 'className'];
  function G5(e, n) {
    var r = Object.keys(e);
    if (Object.getOwnPropertySymbols) {
      var t = Object.getOwnPropertySymbols(e);
  ...
  var f8 = s.forwardRef(function (e, n) {
    var r = e.dir,
      t = e.disabled,
      a = e.invalid,
      i = e.readOnly,
      ...
      J5(
        ...
        {},
        {
          ...
          className: d(
            ...
            i && 'utrecht-textarea--readonly',
            l && 'utrecht-textarea--required',
            u
          ),
          dir: r ?? 'auto',
          disabled: t,
  ...
  function X5(e) {
    for (var n = 1; n < arguments.length; n++) {
      var r = arguments[n] != null ? arguments[n] : {};
      n % 2
        ? z5(Object(r), !0).forEach(function (t) {
            b(e, t, r[t]);
          })
        : Object.getOwnPropertyDescriptors
          ? Object.defineProperties(e, Object.getOwnPropertyDescriptors(r))
          : z5(Object(r)).forEach(function (t) {
              Object.defineProperty(
                e,
                t,
                Object.getOwnPropertyDescriptor(r, t)
  ...
  var m8 = s.forwardRef(function (e, n) {
    var r = e.children,
      t = e.className,
      a = p(e, O8);
    return o.jsx(
      ...
      X5(
        X5({ translate: 'no' }, a),
        {},
        { ref: n, className: d('utrecht-url-data', t), children: r }
      )
    );
  });
  m8.displayName = 'URLData';
  var y8 = ['children', 'className'];
  function Q5(e, n) {
    var r = Object.keys(e);
    if (Object.getOwnPropertySymbols) {
      var t = Object.getOwnPropertySymbols(e);
  ...
  var h8 = s.forwardRef(function (e, n) {
    ...
    return o.jsx(
      ...
      e3(
        e3({ role: 'list' }, a),
        {},
        { ref: n, className: d('utrecht-unordered-list', t), children: r }
      )
    );
  });
  h8.displayName = 'UnorderedList';
  var j8 = ['children', 'className'];
  function r3(e, n) {
    var r = Object.keys(e);
    if (Object.getOwnPropertySymbols) {
      var t = Object.getOwnPropertySymbols(e);
  ...
  function t3(e) {
    for (var n = 1; n < arguments.length; n++) {
      var r = arguments[n] != null ? arguments[n] : {};
      n % 2
        ? r3(Object(r), !0).forEach(function (t) {
            b(e, t, r[t]);
          })
        : Object.getOwnPropertyDescriptors
          ? Object.defineProperties(e, Object.getOwnPropertyDescriptors(r))
          : r3(Object(r)).forEach(function (t) {
              Object.defineProperty(
                e,
                t,
                Object.getOwnPropertyDescriptor(r, t)
  ...
  var g8 = s.forwardRef(function (e, n) {
    var r = e.children,
      t = e.className,
      a = p(e, j8);
    return o.jsx(
      ...
      t3(
        t3({}, a),
        {},
        { ref: n, className: d('utrecht-unordered-list__item', t), children: r }
      )
    );
  });
  g8.displayName = 'UnorderedListItem';
  var A = '/opt/openstad-headless/packages/navBar/src/menuItem.tsx';
  function v8({ item: e, index: n, prefix: r = '', open: t, setOpenIndex: a }) {
    const i = s.useRef(null),
      l = (m) => {
        i.current && !i.current.contains(m.target) && a(null);
      };
    s.useEffect(
      () => (
    ...
    const u = (m) => {
        var y;
        ((y = i.current) != null && y.contains(m.relatedTarget)) || a(null);
      },
      f = (m) =>
        window.location.href.includes(m.replaceAll(' ', '-')) ? 'page' : void 0;
    return s.createElement(
      'div',
      {
        key: n,
        ...
        onMouseEnter: () => a(n),
        __self: this,
        __source: { fileName: A, lineNumber: 42, columnNumber: 5 },
      },
      s.createElement(
        z,
        {
          className: 'level-1',
          href: `${r}${e.slug}`,
          'aria-current': f(e.title),
          __self: this,
          __source: { fileName: A, lineNumber: 47, columnNumber: 7 },
        },
        e.title
      ),
        ...
        s.createElement(
          ...
          s.createElement(
            'button',
            {
              ...
              'aria-expanded': t,
              __self: this,
              __source: { fileName: A, lineNumber: 50, columnNumber: 11 },
            },
            s.createElement('i', {
              className: 'ri-arrow-down-s-line',
              __self: this,
              __source: { fileName: A, lineNumber: 55, columnNumber: 13 },
            }),
            s.createElement(
              'span',
              {
                className: 'sr-only',
                __self: this,
                __source: { fileName: A, lineNumber: 56, columnNumber: 13 },
              },
              t
          ...
          t &&
            s.createElement(
              'div',
              {
                ...
                ref: i,
                __self: this,
                __source: { fileName: A, lineNumber: 59, columnNumber: 13 },
              },
              e._children &&
                e._children.map((m, y) =>
                  s.createElement(
  ...
  var e1 = '/opt/openstad-headless/packages/navBar/src/navBar.tsx';
  function n3({ home: e, content: n, prefix: r = '' }) {
    const [t, a] = s.useState(null);
    s.useEffect(() => {
      const l = new Event('navBarLoaded');
    ...
    return s.createElement(
      'div',
      {
        className: 'container',
        __self: this,
        __source: { fileName: e1, lineNumber: 31, columnNumber: 5 },
      },
      s.createElement(
        'nav',
        {
          id: 'main-menu',
          __self: this,
          __source: { fileName: e1, lineNumber: 32, columnNumber: 7 },
        },
        e &&
          JSON.parse(e).map((l, u) =>
            s.createElement(
              'div',
              {
                key: u,
                className: 'item-container',
                __self: this,
                __source: { fileName: e1, lineNumber: 36, columnNumber: 15 },
              },
              s.createElement(
                z,
                {
                  ...
                  key: u,
                  href: l._url,
                  'aria-current': i(l.title),
                  __self: this,
                  __source: { fileName: e1, lineNumber: 40, columnNumber: 17 },
                },
                l.title
              )
            )
          ),
        JSON.parse(n).map((l, u) =>
          s.createElement(v8, {
            key: u,
            item: l,
            index: u,
            ...
            setOpenIndex: a,
            __self: this,
            __source: { fileName: e1, lineNumber: 47, columnNumber: 13 },
          })
        )
      )
    );
  ...
  return (
    (n3.loadWidgetOnElement = function (e, n) {
      const r = this;
      e &&
        w3
          .createRoot(e)
          .render(
            s.createElement(r, {
              ...n,
              __self: this,
              __source: { fileName: e1, lineNumber: 67, columnNumber: 17 },
            })
          );
    }),
    (k1.NavBar = n3),
