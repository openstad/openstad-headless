module.exports = [
  ...
  },
  {
    ...
    fields: [
      ...
      'newsletterModalFormFields',
      'newsletterModalSubmit',
      'newsletterModalCancel',
      'useCaptchaForNewsletter',
      'captchaLabel',
      'captchaRefreshText',
    ],
  },
  ...
  // or we move these fields to different editor so syncing is not necessary anymore
  {
    ...
    label:
      'Formatted (system use only, visible for debugging, will be hidden in future)',
