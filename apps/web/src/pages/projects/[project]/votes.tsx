      ...
      <PageLayout
        ...
        <div className="container py-6">
          <div className="p-6 bg-white rounded-md">
            ...
            <ul>
              {data?.map((vote: any) => (
                <li className="grid grid-cols-6 items-center py-3 px-2 hover:bg-muted hover:cursor-pointer transition-all duration-200 border-b">
                  <div className="col-span-3">
                    <Paragraph>{vote.id}</Paragraph>
                  </div>
                  <Paragraph className="hidden md:flex truncate md:col-span-2">
                    {vote.createdAt}
                  </Paragraph>
                  <Paragraph className="hidden md:flex truncate md:col-span-1">
                    {vote.ideaId}
                  </Paragraph>
                  <Paragraph className="hidden md:flex truncate md:col-span-1">
                    {vote.userId}
