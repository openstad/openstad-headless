...
export default function CreateProject() {
  ...
  function onSubmit(values: z.infer<typeof formSchema>) {
    createProject(`/api/openstad/api/project`, values);
  }
    ...
    await fetch(url, {
      ...
      body: JSON.stringify({
        ...
        config: {
          ...
          comments: {
            new: {
              anonymous: { redirect: null, notAllowedMessage: null },
