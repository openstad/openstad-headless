...
export function PageLayout({
  ...
  return (
    <main className="bg-background flex flex-row min-h-screen">
      ...
      {location.startsWith("/projects/[project]") ? <SidenavProject /> : null}
      <section className="col-span-full w-full">
        <header className="h-28 flex flex-col justify-center border-b border-border sticky top-0 z-10 bg-background">
