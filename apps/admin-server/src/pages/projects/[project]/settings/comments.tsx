            ...
            <form
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem className="col-span-full md:col-span-1 flex flex-col">
                    <FormLabel>
                      Label bij reacties van medewerkers
                      <InfoDialog
                        content={`Dit is de beschrijving die achter de gebruikersnaam van een medewerker (beheerder of editor) komt te staan. Bijvoorbeeld 'webredactie'.`}
                      />
                    </FormLabel>
                    <FormControl>
                      <Input placeholder="typ een tekst" {...field} />
