      ...
      <PageLayout
        ...
        action={
          <div className="button-container flex flex-row">
            <Link
              href={`/projects/${project}/areas/create-layer`}
                      ...
                      <RemoveResourceDialog
                        ...
                        onDeleteAccepted={() =>
                          item.type === 'Polygoon'
                            ? removeArea(item.id)
                                .then(() =>
                                  toast.success('Polygoon succesvol verwijderd')
                                )
                                .catch(() =>
                                  toast.error(
                                    'Polygoon kon niet worden verwijderd'
                                  )
                                )
                            : removeDatalayer(item.id)
                                .then(() =>
                                  toast.success(
                                    'Kaartlaag succesvol verwijderd'
                                  )
                                )
                                .catch(() =>
                                  toast.error(
                                    'Kaartlaag kon niet worden verwijderd'
                                  )
                                )
                        }
                      />
