...
export default function ProjectCodes() {
  ...
  const { data: accesscodes, deleteAccessCode } = useAccessCodes(
    project as string
  );
      ...
      <PageLayout
        ...
        action={
          <div className="flex flex-row w-full md:w-auto my-auto gap-4">
            <Link
              href={`/projects/${project}/authentication/access-codes/create`}>
                    ...
                    <RemoveResourceDialog
                      ...
                      onDeleteAccepted={() =>
                        deleteAccessCode(code.id)
                          .then(() => toast.success('Toegangscode verwijderd'))
                          .catch((e) =>
                            toast.error(
                              'Toegangscode kon niet worden verwijderd'
                            )
                          )
                      }
                    />
