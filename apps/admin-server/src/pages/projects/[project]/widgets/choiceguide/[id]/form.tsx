...
export default function ChoicesSelectorForm(
  ...
  const defaults = useCallback(
    () => ({
      ...
      imageAspectRatio: props?.[category]?.imageAspectRatio || '16x9',
  ...
  // Push each field into the whole-widget draft under the `choiceGuide`
