...
const choices = [
  ...
  {
    label: 'Rounded corners xs',
    value: 'rounded-xs',
  },
  {
    label: 'Rounded corners sm',
    value: 'rounded-sm',
  },
  {
    label: 'Rounded corners md',
    value: 'rounded-md',
  },
  {
  ...
  },
  {
    ...
    value: 'border-2 border-grey',
  },
  {
    label: 'Border thin blue',
    value: 'border-2 border-blue',
  },
  {
    label: 'Border thin black',
    value: 'border-2 border-black',
  },
  {
  ...
  {
    label: 'Center container (needs (max) width)',
    value: 'mx-auto my-auto',
  },
  {
    label: 'Max width sm',
    value: 'max-w-sm',
