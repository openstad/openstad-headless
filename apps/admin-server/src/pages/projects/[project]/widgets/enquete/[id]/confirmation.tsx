          ...
          {form.watch('confirmationUser') && visibility === 'always' && (
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel>
                    Welk veld moet er worden gebruikt voor de bevestiging naar
                    de gebruiker
                  </FormLabel>
                  <FormDescription>
                    In de &apos;Weergave&apos; opties is ingesteld dat je niet
                    hoeft in te loggen om dit formulier te zien. Hierdoor kan
                    iedereen het formulier invullen en is er geen e-mailadres
                    van de gebruiker beschikbaar om de notificatie naartoe te
                    sturen. Kies hier een veld uit het formulier dat gebruikt
                    wordt om de bevestiging naar de gebruiker te sturen.
                  </FormDescription>
                  <Select
                    value={field.value || ''}
          ...
          {form.watch('confirmationAdmin') && (
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel>
                    Overschrijf het e-mailadres waar de bevesting naartoe wordt
                    gestuurd
                  </FormLabel>
                  <FormDescription>
                    De bevestiging gaat standaard naar de beheerder. Vul hier
                    een ander e-mailadres in om dit te overschrijven. Meerdere
                    e-mailadressen zijn mogelijk, mits ze gescheiden zijn met
                    een komma.
                  </FormDescription>
                  <Input {...field} />
                  <FormMessage />
