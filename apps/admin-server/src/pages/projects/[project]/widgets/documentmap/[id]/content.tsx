...
const formSchema = z.object({
  ...
  minCharactersWarning: z
    .string()
    .optional()
    .default('Nog minimaal {minCharacters} karakters'),
  maxCharactersWarning: z
    .string()
    .optional()
    .default('Je hebt {maxCharacters} karakters teveel'),
        ...
        <form
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                <FormLabel>
                  Welke tekst heeft de knop in de pop-up wanneer je niet bent
                  ingelogd?
                </FormLabel>
                <FormControl>
                  <Input {...field} />
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                <FormLabel>Wil je de titel van de resource tonen?</FormLabel>
                <Select
                  onValueChange={field.onChange}
