...
export default function BegrootmoduleText(
  ...
  const form = useForm<z.infer<typeof formSchema>>({
    ...
    defaultValues: {
      ...
      step1Tab: props.step1Tab ?? '',
      step2Tab: props.step2Tab ?? '',
      step3Tab: props.step3Tab ?? '',
      step4Tab: props.step4Tab ?? '',
      step1Title: props.step1Title ?? '',
      resourceCardTitle: props.resourceCardTitle ?? '',
      step1Delete: props.step1Delete ?? '',
      step1Add: props.step1Add ?? '',
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormDescription>
                    Kies zo dat de titel aansluit op de koppen eromheen. De
                    widget produceert nooit een h1; die hoort bij de pagina
                    zelf.
                  </FormDescription>
                  <FormMessage />
                </FormItem>
