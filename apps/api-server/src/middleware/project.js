...
module.exports = function( req, res, next ) {
  ...
  if (req.path.match('^(/api/repo|/api/template|/api/area|/api/datalayer|/api/widget|/api/image|/api/document|/api/widget-type|/api/project/delete-duplicated-data|/widget|/api/health-check|/$)')) return next();
