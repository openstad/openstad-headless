...
module.exports = function( req, res, next ) {
  ...
  if (req.path.match('^(/api/repo|/api/template|/api/area|/api/datalayer|/api/update-datalayer|/api/proxy|/api/widget|/api/image|/api/document|/api/widget-type|/widget|/$)')) return next();
