...
.get((req, res, next) => {
    ...
    let output = getWidgetJavascriptOutput(widgetSettings, widgetType, componentId, widgetConfig);
...
router
  ...
  .get((req, res) => {
    ...
    let output = getWidgetJavascriptOutput(widgetSettings, widget.type, componentId, widgetConfig);
...
function getWidgetJavascriptOutput(widgetSettings, widgetType, componentId, widgetConfig) {
