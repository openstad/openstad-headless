...
let moduleDefinitions = {
  ...
  resourceoverview: {
    ...
    defaultConfig: {
      ...
      searchHint: 'Zoekt op woorden in de titel, samenvatting en beschrijving.',
      displaySearchPlaceholder: true,
      ...
      locationLabel: 'Vul een postcode in',
      displayLocationHint: false,
      locationHint: 'Typ een postcode en kies een adres uit de lijst.',
      locationPlaceholder: '',
