    ...
    task: async (next) => {
      try {
        ...
        for (const resource of resources) {
          // Workaround for validation in Resource model. Copy rather than
          // mutate: `auth` is shared across every instance of the model.
        ...
        for (const comment of comments) {
          // Workaround for validation in Comment model. Copy rather than
          // mutate: `auth` is shared across every instance of the model.
