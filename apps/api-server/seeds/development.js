...
module.exports = async function seed(config, db) {
  try {
    ...
    let resource1 = await db.Resource.create({
      ...
      summary:
        'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Pellentesque a sollicitudin velit, ac vehicula nibh.',
      description:
      ...
      location: {
        ...
        lng: 4.9005494 + (Math.random() * 0.03 - 0.015),
      },
    ...
    let resource4 = await db.Resource.create({
      ...
      summary:
        'Ut eu porttitor odio. Aliquam nec volutpat diam. Etiam eget tempor lacus, sed aliquet lectus.',
      description:
    ...
    let resource6 = await db.Resource.create({
      ...
      summary:
        'Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia curae; Fusce ornare.',
      description:
        'Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia curae; Fusce ornare felis id lacinia sodales. Vivamus augue ligula, ullamcorper ac volutpat non, scelerisque at neque. Nulla laoreet, sapien ac iaculis sodales, massa lacus auctor felis, consequat gravida lorem erat sed metus. Fusce lacus mauris, cursus id magna ullamcorper, lacinia eleifend mauris. Etiam scelerisque molestie dui congue eleifend. Phasellus a tortor nibh. Ut vestibulum ut risus at finibus.',
      images: [
        { url: `${process.env.IMAGE_APP_URL}/image/forum.romanum.01.jpg` },
      ],
      location: {
        lat: 52.3710476 + (Math.random() * 0.03 - 0.015),
        lng: 4.9005494 + (Math.random() * 0.03 - 0.015),
    ...
    let resource8 = await db.Resource.create({
      ...
      summary:
        'Aliquam ut magna eget ante tempor consectetur non nec nibh. Etiam id tellus eget turpis.',
      description:
        'Aliquam ut magna eget ante tempor consectetur non nec nibh. Etiam id tellus eget turpis porta egestas. Sed maximus sed nisi vel ornare. Aliquam erat volutpat. Phasellus lobortis nibh in convallis eleifend. Morbi nunc nisi, consequat nec odio a, efficitur congue ipsum. Donec nec leo id urna scelerisque rutrum. Donec pulvinar nunc nisl, at dignissim purus dapibus at. Phasellus pellentesque sem turpis, et facilisis nisl tempus at.',
      images: [
        { url: `${process.env.IMAGE_APP_URL}/image/forum.romanum.03.jpg` },
      ],
      location: {
        lat: 52.3710476 + (Math.random() * 0.03 - 0.015),
    ...
    let resource9 = await db.Resource.create({
      ...
      summary:
        'Etiam ultricies dui non justo laoreet convallis. Aenean odio erat, molestie et odio in, imperdiet.',
      description:
        'Etiam ultricies dui non justo laoreet convallis. Aenean odio erat, molestie et odio in, imperdiet consectetur mauris. Pellentesque lobortis lacus sodales, volutpat turpis vel, posuere purus. Aliquam non elementum dolor. Ut vel dolor nec purus hendrerit molestie. Sed tortor erat, facilisis vitae orci sit amet, maximus viverra diam. Ut non sem mollis, facilisis libero id, sollicitudin felis. Donec at orci fermentum, pretium nunc a, dictum mauris. In tristique quis sapien sed faucibus. Quisque posuere purus tortor, quis gravida mauris cursus ac. Integer semper turpis quis magna consectetur, blandit placerat tellus lobortis. Morbi commodo sem iaculis nunc ornare, vel lobortis enim lacinia. Sed vitae lacus ex.',
      images: [
        { url: `${process.env.IMAGE_APP_URL}/image/forum.romanum.04.jpg` },
      ],
      location: {
        lat: 52.3710476 + (Math.random() * 0.03 - 0.015),
        lng: 4.9005494 + (Math.random() * 0.03 - 015),
    ...
    await db.Comment.create({
      ...
      resourceId: 1,
      description:
        'In id vestibulum leo. Integer a justo quis est porttitor auctor. Orci varius natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Pellentesque porta laoreet scelerisque. Etiam laoreet ultrices est, vitae malesuada magna tempor eu.',
      sentiment: 'for',
    });
    ...
    await db.Comment.create({
      ...
      sentiment: 'for',
      description:
        'Sed egestas sapien nec tristique cursus. Nunc euismod tempus nisl, sit amet malesuada velit. Vivamus nec nulla eleifend, congue dolor quis, dignissim est. Maecenas rhoncus tellus et augue efficitur tincidunt. Ut euismod libero vel lorem semper.',
    });
    ...
    await db.Comment.create({
      ...
      resourceId: 1,
      description:
        'Aliquam tincidunt enim et arcu dictum, mollis consequat ligula feugiat. Cras vel imperdiet eros. Nulla finibus sed metus a mattis. Aenean lobortis fringilla felis id congue. Cras lacus justo, imperdiet in tellus vitae, volutpat pretium dolor.',
      sentiment: 'for',
    });
    ...
    await db.Comment.create({
      ...
      resourceId: 1,
      description:
        'Curabitur vestibulum ex sem, in tempor mi ullamcorper vitae. Aenean dui magna, auctor in eleifend nec, elementum quis massa. Etiam quis eros sapien. Mauris ornare mi ut justo pretium, quis mollis sapien pulvinar. Maecenas feugiat sapien.',
      sentiment: 'for',
    });
    ...
    await db.Comment.create({
      ...
      resourceId: 2,
      description:
        'Mauris a vestibulum justo, a mattis purus. Phasellus auctor eros vitae augue dictum aliquam. Pellentesque quis pulvinar est, sed congue metus. Morbi volutpat velit libero, ac condimentum justo egestas ac. Integer eu sollicitudin mauris. Curabitur sed.',
      sentiment: 'for',
    });
    ...
    await db.Widget.create({
      ...
      config: {
        ...
        tagGroups: [
          { type: 'theme', multiple: true, label: 'Thema' },
    ...
    await db.Widget.create({
      ...
      config: {
        ...
        displayBudgetDocuments: false,
        projectId: '2',
        resourceIdRelativePath: '/plan?osid=[id]',
        commentsWidget: { useSentiments: ['for', 'against'] },
      },
    });
    ...
    await db.ChoicesGuide.create({
      ...
      config:
        '{"isActive":true,"submissionType":"form","requiredUserRole":"member","withExisting":"error"}',
    });
    ...
    await db.ChoicesGuideQuestionGroup.create({
      ...
      description:
        'Zonder beschrijving, maar met een <a href="https://nlsvgtr.nl" target="_blank" rel="noreferrer noopener">link</a>',
      seqnr: 10,
    });
    ...
    await db.ChoicesGuideQuestion.create({
      ...
      dimensions: '["x","y"]',
      values:
        '[ { "text": "Linksboven", "value": { "x": "0", "y": "0" } }, { "text": "Linksonder", "value": { "x": 0, "y": 100 } }, { "text": "Rechtsboven", "value": { "x": 100, "y": 0 } }, { "text": "Rechtsonder", "value": { "x": 100, "y": 100 } } ]',
      seqnr: 30,
    });
    ...
    await db.ChoicesGuideQuestion.create({
      ...
      dimensions: '["y"]',
      values:
        '[ { "text": "Ja", "value": { "x": "0", "y": "0" } }, { "text": "Nee", "value": { "x": "100", "y": "100" } } ]',
      seqnr: 100,
    });
    ...
    await db.ChoicesGuideChoice.create({
      ...
      answers:
        '{ "35": { "x": 0, "y": 0 }, "36": { "x": "0", "y": 0 }, "37": { "x": 0, "y": 0 } }',
      seqnr: 10,
    });
    ...
    await db.ChoicesGuideChoice.create({
      ...
      answers:
        '{ "35": { "x": 100, "y": 0 }, "36": { "x": 100, "y": 0 }, "37": { "x": 100, "y": 0 } }',
      seqnr: 20,
    });
    ...
    await db.ChoicesGuideChoice.create({
      ...
      answers:
        '{ "35": { "x": 0, "y": 100 }, "36": { "x": 0, "y": 100 }, "37": { "x": 0, "y": 100 } }',
      seqnr: 30,
    });
    ...
    await db.ChoicesGuideChoice.create({
      ...
      answers:
        '{ "35": { "x": 100, "y": 100 }, "36": { "x": 100, "y": 100 }, "37": { "x": 100, "y": 100 } }',
      seqnr: 40,
    });
  } catch (err) {
    console.log(err);
