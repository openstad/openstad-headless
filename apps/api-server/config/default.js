...
let AUTH_JWTSECRET = process.env.AUTH_JWTSECRET;
try {
  AUTH_JWTSECRET = JSON.parse(AUTH_JWTSECRET);
} catch (err) {}
let AUTH_ADAPTER = process.env.AUTH_ADAPTER;
try {
  AUTH_ADAPTER = JSON.parse(AUTH_ADAPTER);
} catch (err) {}
let AUTH_ADAPTER_OPENSTAD = process.env.AUTH_ADAPTER_OPENSTAD;
try {
  AUTH_ADAPTER_OPENSTAD = JSON.parse(AUTH_ADAPTER_OPENSTAD);
} catch (err) {}
let AUTH_ADAPTER_OIDC = process.env.AUTH_ADAPTER_OIDC;
try {
  AUTH_ADAPTER_OIDC = JSON.parse(AUTH_ADAPTER_OIDC);
} catch (err) {}
let AUTH_PROVIDER = process.env.AUTH_PROVIDER;
try {
  AUTH_PROVIDER = JSON.parse(AUTH_PROVIDER);
} catch (err) {}
let AUTH_PROVIDER_DEFAULT = process.env.AUTH_PROVIDER_DEFAULT;
try {
  AUTH_PROVIDER_DEFAULT = JSON.parse(AUTH_PROVIDER_DEFAULT);
} catch (err) {}
let AUTH_PROVIDER_OPENSTAD = process.env.AUTH_PROVIDER_OPENSTAD;
try {
  AUTH_PROVIDER_OPENSTAD = JSON.parse(AUTH_PROVIDER_OPENSTAD);
} catch (err) {}
let AUTH_PROVIDER_ANONYMOUS = process.env.AUTH_PROVIDER_ANONYMOUS;
try {
  AUTH_PROVIDER_ANONYMOUS = JSON.parse(AUTH_PROVIDER_ANONYMOUS);
} catch (err) {}
let AUTH_FIXEDAUTHTOKENS =
  process.env.AUTH_FIXEDAUTHTOKENS ||
  process.env.API_AUTHORIZATION_FIXEDAUTHTOKENS;
try {
  AUTH_FIXEDAUTHTOKENS = JSON.parse(AUTH_FIXEDAUTHTOKENS);
} catch (err) {}
let RESOURCES_LOCATION = process.env.RESOURCES_LOCATION;
try {
