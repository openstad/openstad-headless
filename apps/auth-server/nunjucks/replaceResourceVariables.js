  ...
  const variables = [
    {
      key: '%meeting%',
      value:
        resource && resource.agendas && resource.agendas.length > 0
    ...
    },
    {
      ...
      value:
        resource && resource.info && resource.info.explanation_budget_approval
    ...
    },
    {
      ...
      value:
        resource && resource.info && resource.info.explanation_budget_rejection
