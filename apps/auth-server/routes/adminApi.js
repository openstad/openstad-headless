...
module.exports = (app) => {
  ...
  app.post(
    '/api/admin/csrf-session-token',
    userMw.withAll,
    adminApiUserController.csrfSessionToken
  );
  ...
  app.get(
    '/api/admin/unique-code/:codeId',
    codeMw.withOne,
    adminApiUniqueCodeController.show
  );
  app.post(
  ...
  app.post(
    '/api/admin/unique-code/:codeId/delete',
    codeMw.deleteOne,
    adminApiUniqueCodeController.delete
  );
  app.post(
    '/api/admin/unique-code/:codeId/reset',
    codeMw.withOne,
    codeMw.reset,
  ...
  app.post(
    '/api/admin/access-code/:codeId/delete',
    accessCodeMw.deleteOne,
    adminApiAccessCodeController.delete
  );
